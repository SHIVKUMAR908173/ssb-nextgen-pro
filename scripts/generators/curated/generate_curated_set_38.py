...
set_38_data = {
  "set_id": "SET_38",
  "description": "High-Quality Curated SSB Dataset - Set 38",
  "TAT": [
    {"pic_no": 1, "description": "A young technician repairing a solar-powered drip-feed irrigation valve in a terrace farm.", "image_url": "https://picsum.photos/seed/tat_set38_1/800/600"},
    {"pic_no": 2, "description": "A research engineer adjusting the sample slide inside a scanning confocal microscope.", "image_url": "https://picsum.photos/seed/tat_set38_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing dry brambles to open a historical hiking trail path.", "image_url": "https://picsum.photos/seed/tat_set38_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining government student loan schemes to rural high school graduates.", "image_url": "https://picsum.photos/seed/tat_set38_4/800/600"},
    {"pic_no": 5, "description": "A structural technician checking cable anchor bolts on a newly built steel truss bridge span.", "image_url": "https://picsum.photos/seed/tat_set38_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet locating search grid segments on a regional topographical satellite chart.", "image_url": "https://picsum.photos/seed/tat_set38_6/800/600"},
    {"pic_no": 7, "description": "A mechanic replacing planetary reduction gears on an electric mining shovel motor.", "image_url": "https://picsum.photos/seed/tat_set38_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing primary first-aid bandages and antiseptic lotions at a disaster base.", "image_url": "https://picsum.photos/seed/tat_set38_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists placing concrete nursery domes to protect juvenile marine abalone.", "image_url": "https://picsum.photos/seed/tat_set38_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking ripe grapes in a terrace vineyard using a double-basket picker frame.", "image_url": "https://picsum.photos/seed/tat_set38_10/800/600"},
    {"pic_no": 11, "description": "A dispatcher monitoring emergency logistics fleet transits on a wide command-center display.", "image_url": "https://picsum.photos/seed/tat_set38_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Irrigation", "Confocal", "Brambles", "Loan", "Anchor", "Topographical", "Shovel", "Antiseptic", "Abalone", "Vineyard", 
  ...
  "SRT": [
    "He is leading a drip irrigation valve installation team and a sudden heavy rockfall damages the primary manifold. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB spatial orientation check. He...",
    ...
    "He find a cloned social media portal soliciting emergency funds using his father's profile photo. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set38/800/600?blur=5",
    "description": "Hazy picture of a young technician repairing a solar-powered drip-feed irrigation valve in a terrace farm."
  },

  "PI": [
    "How do you handle a team supervisor who frequently provides self-contradictory research guidelines?",
    "Tell me about a time you organized a local street cleanliness flash-mob in your hometown.",
    "What is your view on the military applications of high-altitude tethered aerostat radar platforms?",
    "How do you manage your physical stamina build-up during long, humid summer months?",
    "Tell me about a time you stood up against unfair selection parameters in your university cultural club.",
    "What are the main differences between passive sonar and active sonar systems in marine scouting?",
    "How do you prioritize your time when your primary semester exams directly overlap with your NCC camp?",
    "Tell me about a time you successfully helped a classmate overcome a severe stage fear before a presentation.",
    "If you are assigned to a group project where the coordinator is highly passive, how do you drive progress?",
    "What is your opinion on the strategic role of international marine corridor policing in global trade?",
    "Tell me about a major family medical crisis where you took charge of coordinating all emergency blood donors.",
    "What does structural integrity mean to you when assessing the design of a software app, in your own words?",
    "What is the significance of the motto 'Loyalty and Fortitude' in your daily personal interactions?",
    "How do you deal with a team partner who has extremely high technical precision but is highly aggressive?",
    "What role does tactical air mobility play in high-altitude rescue and disaster logistics?",
    "Tell me about a time you volunteered to lead a school health and cleanliness drive in a nearby slum.",
    "What are your views on India's strategic relations with Indian Ocean island nations?",
    "If you are not selected, what specific career options in satellite communication payloads or ground stations have you planned?",
    "How do you handle a teammate who continuously borrows your lab instruments without returning them on time?",
    "What is the most challenging long-distance marathon or cross-country running event you have completed?"
  ],
  ...
  "Lecturette": [
    "High-Altitude Tethered Aerostat Radars: Strategic Advantages",
    "Passive vs Active Sonar: Marine Detection Frontiers",
    "International Marine Corridor Policing: Challenges and Value",
    "Tactical Air Mobility in Disaster and Emergency Logistics"
  ],

  "GD": [
    "Should the development of space-based solar power generation systems be funded exclusively as a global public good, or should private corporations be granted exclusive patent rights to accelerate development?",
    "Does the increasing reliance of intelligence agencies on artificial intelligence systems for threat detection increase global stability, or does it merely heighten the risk of automated accidental escalations?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set38/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_38.json"), 'w', encoding='utf-8') as f:
    json.dump(set_38_data, f, indent=2)

print("Set 38 created successfully with CPSS.")
