...
set_55_data = {
  "set_id": "SET_55",
  "description": "High-Quality Curated SSB Dataset - Set 55",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital lux meter in a vertical indoor farm.", "image_url": "https://picsum.photos/seed/tat_set55_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a perovskite solar cell film for efficiency.", "image_url": "https://picsum.photos/seed/tat_set55_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets painting the boundary walls of a village primary school.", "image_url": "https://picsum.photos/seed/tat_set55_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining Sukanya Samriddhi Yojana benefits to parents of girl children.", "image_url": "https://picsum.photos/seed/tat_set55_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the torsional rigidity of a vehicle chassis frame.", "image_url": "https://picsum.photos/seed/tat_set55_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting high-altitude intercept profiles on a radar screen.", "image_url": "https://picsum.photos/seed/tat_set55_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged governor on a stationary diesel engine.", "image_url": "https://picsum.photos/seed/tat_set55_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a free health check-up camp for elderly villagers.", "image_url": "https://picsum.photos/seed/tat_set55_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring snow leopard tracks using motion-sensor camera traps.", "image_url": "https://picsum.photos/seed/tat_set55_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a portable chlorophyll meter to check leaf nitrogen levels.", "image_url": "https://picsum.photos/seed/tat_set55_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring automated guided vehicle (AGV) paths in a smart warehouse.", "image_url": "https://picsum.photos/seed/tat_set55_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Lux-meter", "Perovskite", "Painting", "Sukanya", "Torsional", "Intercept", "Governor", "Health-camp", "Camera-trap", "Chlorophyll", 
  ...
  "SRT": [
    "He is calibrating a digital lux meter and the reading fluctuates wildly due to ambient light. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB intercept profile check. He...",
    "He discovers that a local water storage tank is leaking water into the surrounding area. He...",
    "While attending a health camp, he notices a short circuit in the lighting wiring causing sparks. He...",
    "He is organizing a district badminton tournament and the main scoreboard fails during the final match. He...",
    "He finds a lost leather pouch containing cash and receipts lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel water supply is cut off. He...",
    "A group of wild monkeys enters the classroom during an ongoing lecture. He...",
    "He is traveling on a desert route and the bus driver loses the way. He...",
    "He is accused of cheating in a lab exam that he had prepared well for. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set55/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital lux meter in a vertical indoor farm."
  },

  "PI": [
    "How do you handle a situation where a light measurement instrument fails during a vertical farm project?",
    "Tell me about a time you led a team to paint walls or renovate a village school or public space.",
    "What is your understanding of the strategic importance of perovskite solar cells in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the wastage of water or public resources?",
    "What are the technical challenges in testing the torsional rigidity of chassis frames?",
    "How do you handle a situation where you are falsely accused of cheating in a lab exam?",
  ...
  "Lecturette": [
    "Perovskite Solar Cells: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like perovskites be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set55/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_55.json"), 'w', encoding='utf-8') as f:
    json.dump(set_55_data, f, indent=2)

print("Set 55 created successfully with CPSS.")
