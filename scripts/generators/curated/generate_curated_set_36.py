...
set_36_data = {
  "set_id": "SET_36",
  "description": "High-Quality Curated SSB Dataset - Set 36",
  "TAT": [
    {"pic_no": 1, "description": "A young technician setting up a solar-powered telemetry transponder on a rocky mountain top.", "image_url": "https://picsum.photos/seed/tat_set36_1/800/600"},
    {"pic_no": 2, "description": "A research engineer adjusting the focus of a vacuum chamber fusion experiment reactor.", "image_url": "https://picsum.photos/seed/tat_set36_2/800/600"},
    {"pic_no": 3, "description": "A group of cadets building a gravel check dam to conserve water in a dry village stream.", "image_url": "https://picsum.photos/seed/tat_set36_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining online digital signature benefits to local library workers.", "image_url": "https://picsum.photos/seed/tat_set36_4/800/600"},
    {"pic_no": 5, "description": "A construction foreman checking weld integrity on a structural steel highway girder span.", "image_url": "https://picsum.photos/seed/tat_set36_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet analyzing high-altitude thermal wind contours on a dual-screen radar console.", "image_url": "https://picsum.photos/seed/tat_set36_6/800/600"},
    {"pic_no": 7, "description": "A technician repairing a high-power magnetic coupler drive on an industrial mill shaft.", "image_url": "https://picsum.photos/seed/tat_set36_7/800/600"},
    {"pic_no": 8, "description": "A young woman setting up a temporary primary child immunization register in a remote camp.", "image_url": "https://picsum.photos/seed/tat_set36_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists placing concrete nursery grid boxes to protect sea grass sprigs.", "image_url": "https://picsum.photos/seed/tat_set36_9/800/600"},
    {"pic_no": 10, "description": "A worker picking ripe papayas in a high-density orchard using a soft fabric picker basket.", "image_url": "https://picsum.photos/seed/tat_set36_10/800/600"},
    {"pic_no": 11, "description": "A dispatcher mapping regional fire emergency truck transit routes on a large wall display.", "image_url": "https://picsum.photos/seed/tat_set36_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Transponder", "Fusion", "Gravel", "Signature", "Girder", "Thermal", "Coupler", "Immunization", "Sprigs", "Fabric", 
  ...
  "SRT": [
    "He is leading a telemetry transponder installation team and a sudden rockslide crushes the power generator. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB medical fitness validation. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set36/800/600?blur=5",
    "description": "Hazy picture of a young technician setting up a solar-powered telemetry transponder on a rocky mountain top."
  },

  "PI": [
    "How do you handle a senior student who tries to enforce outdated or restrictive customs on freshmen?",
    "Tell me about a time you volunteered to manage the registration and logistics of a rural eye screening camp.",
    "What is your view on the strategic challenge of submarine optical cable security in modern naval warfare?",
    "How do you maintain focus on academic preparations when a family member is suffering from a prolonged chronic illness?",
    "Tell me about a time you had to stand your ground against a major ethical violation in your university exam office.",
    "What are the key technical differences between solid-state batteries and lithium-ion batteries for electric flight?",
    "How do you allocate personal preparation hours when you are coordinating a university NCC drill team?",
    "Tell me about a time you successfully negotiated a complex venue clash between two active student clubs.",
    "If you are assigned to lead a team of highly experienced specialists who feel you are too young, how do you gain their respect?",
    "What is your opinion on the geopolitical impact of rare earth element supply chain monopolies?",
    "Tell me about a major logistics challenge you faced during a long-distance cycling trek across mountain passes.",
    "What is the distinction between reactive obedience and proactive compliance in military training, in your own words?",
    "What is the significance of the motto 'Discipline and Devotion' in your daily routine?",
    "How do you deal with a colleague who is highly creative but constantly neglects to document their work?",
    "What role does redundancy play in building fault-tolerant communication networks for disaster response?",
    "Tell me about a time you volunteered to lead a village water sanitization awareness camp.",
    "What are your views on India's strategic maritime partnerships with Southwest Indian Ocean island nations?",
    "If you are not selected, what specific master's programs in control systems or autonomous avionics will you pursue?",
    "How do you handle a roommate who consistently uses your electricity adapters and returns them damaged?",
    "What is the most challenging high-altitude mountaineering trek or survival camp you have completed?"
  ],
  ...
  "Lecturette": [
    "Submarine Optical Cable Security: Geopolitical Vulnerabilities",
    "Solid-State Batteries: Future of Electric Flight and Transport",
    "Rare Earth Element Supply Chains: Strategic Geopolitics",
    "The Role of Redundancy in Fault-Tolerant Disaster Communication Networks"
  ],

  "GD": [
    "Should the mining of deep-sea hydrothermal vents for cobalt and nickel be globally banned until complete environmental impact models are proven, or should it be regulated commercially to speed up renewable transitions?",
    "Does the growth of central bank digital currencies (CBDCs) enhance financial inclusion, or does it merely give governments direct oversight to curb individual spending privacy?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set36/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_36.json"), 'w', encoding='utf-8') as f:
    json.dump(set_36_data, f, indent=2)

print("Set 36 created successfully with CPSS.")
