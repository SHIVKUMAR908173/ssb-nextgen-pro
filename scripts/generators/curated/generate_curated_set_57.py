...
set_57_data = {
  "set_id": "SET_57",
  "description": "High-Quality Curated SSB Dataset - Set 57",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital gaussmeter in a magnetics lab.", "image_url": "https://picsum.photos/seed/tat_set57_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a graphene foam sample for energy storage applications.", "image_url": "https://picsum.photos/seed/tat_set57_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing water hyacinth from a historic temple tank.", "image_url": "https://picsum.photos/seed/tat_set57_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining PM-SVANidhi scheme benefits and loans to street vendors.", "image_url": "https://picsum.photos/seed/tat_set57_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the flexural strength of a 3D printed plastic beam.", "image_url": "https://picsum.photos/seed/tat_set57_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting polar navigation routes on a polar stereographic chart.", "image_url": "https://picsum.photos/seed/tat_set57_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged bellows on an expansion joint.", "image_url": "https://picsum.photos/seed/tat_set57_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a heritage walk for local school children.", "image_url": "https://picsum.photos/seed/tat_set57_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring dugong populations using aerial boat surveys.", "image_url": "https://picsum.photos/seed/tat_set57_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a digital leaf wetness sensor to predict crop disease.", "image_url": "https://picsum.photos/seed/tat_set57_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring warehouse humidity levels on a dashboard.", "image_url": "https://picsum.photos/seed/tat_set57_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Gaussmeter", "Graphene-foam", "Temple-tank", "SVANidhi", "Flexural", "Polar-nav", "Bellows", "Heritage-walk", "Dugong", "Leaf-wetness", 
  ...
  "SRT": [
    "He is calibrating a digital gaussmeter and the reading fluctuates wildly due to stray magnetic fields. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB polar navigation check. He...",
    "He discovers that a local expansion joint bellows is leaking steam in the plant. He...",
    "While conducting a heritage walk, he notices a short circuit in the audio guide system causing sparks. He...",
    "He is organizing a district swimming tournament and the main scoreboard fails during the final match. He...",
    "He finds a lost folder containing original property documents lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel generator fails during a power cut. He...",
    "A pack of wild dogs attacks his herd of cattle near the forest edge. He...",
    "He is traveling on a bus and the driver gets a sudden severe toothache and loses focus. He...",
    "He is accused of cheating in a math test that he had prepared well for. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set57/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital gaussmeter in a magnetics lab."
  },

  "PI": [
    "How do you handle a situation where a magnetic measurement instrument fails during a lab project?",
    "Tell me about a time you led a team to clear water hyacinth or clean up a temple tank or public space.",
    "What is your understanding of the strategic importance of graphene foam in defense?",
    ...
    "What are the technical challenges in testing the flexural strength of 3D printed materials?",
    "How do you handle a situation where you are falsely accused of cheating in a math test?",
  ...
  "Lecturette": [
    "Graphene Foam: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like graphene foam be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set57/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_57.json"), 'w', encoding='utf-8') as f:
    json.dump(set_57_data, f, indent=2)

print("Set 57 created successfully with CPSS.")
