...
set_32_data = {
  "set_id": "SET_32",
  "description": "High-Quality Curated SSB Dataset - Set 32",
  "TAT": [
    {"pic_no": 1, "description": "A young technician repairing a solar-powered water pump system in a rural school courtyard.", "image_url": "https://picsum.photos/seed/tat_set32_1/800/600"},
    {"pic_no": 2, "description": "A laboratory researcher testing the tensile strength of an experimental composite material.", "image_url": "https://picsum.photos/seed/tat_set32_2/800/600"},
    {"pic_no": 3, "description": "A group of volunteers clearing dry underbrush to create a firebreak near a forest edge.", "image_url": "https://picsum.photos/seed/tat_set32_3/800/600"},
    {"pic_no": 4, "description": "A student teaching basic coding logic to underprivileged primary school children in a community hall.", "image_url": "https://picsum.photos/seed/tat_set32_4/800/600"},
    {"pic_no": 5, "description": "A construction supervisor checking safety cable tensions on an elevated metro rail span.", "image_url": "https://picsum.photos/seed/tat_set32_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet explaining navigation chart vectors to peers around a wooden planning desk.", "image_url": "https://picsum.photos/seed/tat_set32_6/800/600"},
    {"pic_no": 7, "description": "A mechanic servicing the planetary gear assembly of a heavy farm harvester tractor.", "image_url": "https://picsum.photos/seed/tat_set32_7/800/600"},
    {"pic_no": 8, "description": "A young woman delivering first-aid and hygiene kits to families in a seasonal flood relief camp.", "image_url": "https://picsum.photos/seed/tat_set32_8/800/600"},
    {"pic_no": 9, "description": "Two marine scientists tagging juvenile sea turtles for research on a sandy beach at night.", "image_url": "https://picsum.photos/seed/tat_set32_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking fresh pomegranates in an organic orchard using a double-basket pole.", "image_url": "https://picsum.photos/seed/tat_set32_10/800/600"},
    {"pic_no": 11, "description": "A dispatcher monitoring emergency vehicle transit routes on a large control room GPS screen.", "image_url": "https://picsum.photos/seed/tat_set32_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Pump", "Tensile", "Firebreak", "Coding", "Metro", "Vector", "Harvester", "Hygiene", "Tagging", "Pomegranate", 
    "Transit", "Apex", "Bold", "Cope", "Drive", "Earn", "Firm", "Glow", "Hope", "Keen", 
  ...
  "SRT": [
    "He is leading a water pump maintenance team and a sudden electrical short circuit starts a fire in the pump room. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB medical checkup. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set32/800/600?blur=5",
    "description": "Hazy picture of a young technician repairing a solar-powered water pump system in a rural school courtyard."
  },

  "PI": [
    "How do you manage a colleague who consistently spreads rumors or gossip in the workplace?",
  ...
  "Lecturette": [
    "Unmanned Underwater Vehicles (UUVs) in Modern Maritime Warfare",
    "Precision-Guided Munitions vs Traditional Artillery",
    "The Geopolitics of Space-Based Assets and Surveillance",
    "The Distinction Between Physical Fitness and Moral Courage"
  ],

  "GD": [
    "Should the use of artificial intelligence in recruiting and hiring be banned to prevent bias, or is it a necessary tool for large-scale screening?",
    "Does the rapid expansion of solar microgrids in developing nations bypass the need for traditional grid infrastructure, or is it a temporary solution?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set32/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_32.json"), 'w', encoding='utf-8') as f:
    json.dump(set_32_data, f, indent=2)

print("Set 32 created successfully with CPSS.")
