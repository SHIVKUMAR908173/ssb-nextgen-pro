...
set_42_data = {
  "set_id": "SET_42",
  "description": "High-Quality Curated SSB Dataset - Set 42",
  "TAT": [
    {"pic_no": 1, "description": "A young technician tuning a microwave refractometer probe inside a high-altitude telescope dome.", "image_url": "https://picsum.photos/seed/tat_set42_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting the cryo-insulation blanket around a heavy rocket booster fuel tank.", "image_url": "https://picsum.photos/seed/tat_set42_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets setting up solar-powered lanterns around an isolated night education shelter.", "image_url": "https://picsum.photos/seed/tat_set42_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer helping a dairy farmer navigate a mobile livestock health audit portal.", "image_url": "https://picsum.photos/seed/tat_set42_4/800/600"},
    {"pic_no": 5, "description": "A structural technician measuring welding bead alignments on a large steel pipeline support frame.", "image_url": "https://picsum.photos/seed/tat_set42_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet drawing flight descent corridors on a regional approach radar display.", "image_url": "https://picsum.photos/seed/tat_set42_6/800/600"},
    {"pic_no": 7, "description": "A mechanic fitting replacement roller bearings inside a heavy excavator drive wheel gear track.", "image_url": "https://picsum.photos/seed/tat_set42_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing packed dry meals and sterile drinking straws at a shelter camp.", "image_url": "https://picsum.photos/seed/tat_set42_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists constructing artificial coral frames to restore a shallow coastal lagoon.", "image_url": "https://picsum.photos/seed/tat_set42_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking sweet red cherries in a hillside orchard using a high tripod ladder frame.", "image_url": "https://picsum.photos/seed/tat_set42_10/800/600"},
    {"pic_no": 11, "description": "A warehouse dispatcher matching emergency transport manifests on a large multi-screen platform.", "image_url": "https://picsum.photos/seed/tat_set42_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Refractometer", "Cryo-insulation", "Stepwell", "Livestock", "Welding", "Corridors", "Bearings", "Lagoon", "Cherries", "Dispatcher", 
  ...
  "SRT": [
    "He is leading a telescope refractometer calibration team and a sudden sudden software freeze locks the primary mirror drive. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB visual approach checks. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set42/800/600?blur=5",
    "description": "Hazy picture of a young technician tuning a microwave refractometer probe inside a high-altitude telescope dome."
  },

  "PI": [
    "How do you handle a lab evaluator who continuously questions your project methodology during an academic presentation?",
    "Tell me about a time you organized a volunteer group to clear dry scrub from historical monuments in your district.",
    "What is your view on the military applications of high-bandwidth laser crosslinks in satellite constellations?",
    "How do you manage your physical training performance under hot, humid summer conditions without losing stamina?",
    "Tell me about a time you stood up against biased department funding distribution practices in college.",
    "What are the key technical challenges in designing high-pressure hydrogen storage tanks for clean transit fleets?",
    "How do you resolve a resource conflict when two university societies require the same main auditorium?",
    "Tell me about a time you successfully helped a classmate regain focus during a high-stress competitive interview.",
    "If you are assigned to a project team where the former leader reports to you, how do you secure their support?",
    "What is your opinion on the strategic role of Southern Ocean fisheries management treaties?",
    "Tell me about a major family logistics task you completed during a sudden regional telecommunications blackout.",
    "What does team spirit mean to you when executing a complex suspended rope bridge crossing?",
    "What is the significance of the motto 'Service and Strength' in your everyday student interactions?",
    "How do you handle a teammate who has high structural discipline but lacks any original design concepts?",
    "What role does real-time satellite telemetry play in predicting volcanic ash cloud movements?",
    "Tell me about a time you volunteered to coordinate parking arrangements during a crowded local athletics meet.",
    "What are your views on India's strategic maritime partnership with South Indian Ocean littoral nations?",
    "If you are not selected, what backup plans in autonomous flight dynamics or satellite telemetry do you have?",
    "How do you handle a classmate who consistently utilizes your library research materials without acknowledgment?",
    "What is the most challenging 100-kilometer bicycle ride or wilderness survival hike you have completed?"
  ],
  ...
  "Lecturette": [
    "Laser Crosslinks in Satellites: Strategic Communications Advantage",
    "Hydrogen Storage in Clean Transit: Core Engineering Hurdles",
    "Southern Ocean Treaties: Fisheries Management and Geopolitics",
    "Satellite Telemetry in Volcanic Ash Cloud Tracking"
  ],

  "GD": [
    "Should the development of hydrogen fuel cell storage networks be funded exclusively by local public entities, or should private energy conglomerates be granted unlimited patent titles to accelerate development?",
    "Does the rapid integration of facial recognition technology in municipal public spaces reduce local crime rates, or does it merely lead to systemic privacy violations and profiling?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set42/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_42.json"), 'w', encoding='utf-8') as f:
    json.dump(set_42_data, f, indent=2)

print("Set 42 created successfully with CPSS.")
