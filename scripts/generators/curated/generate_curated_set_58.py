...
set_58_data = {
  "set_id": "SET_58",
  "description": "High-Quality Curated SSB Dataset - Set 58",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital vibrometer on a rotating machine.", "image_url": "https://picsum.photos/seed/tat_set58_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a bio-plastic film for eco-friendly packaging applications.", "image_url": "https://picsum.photos/seed/tat_set58_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing plastic waste from a river ghat after a local festival.", "image_url": "https://picsum.photos/seed/tat_set58_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining PM-KUSUM scheme benefits and solar pumps to farmers.", "image_url": "https://picsum.photos/seed/tat_set58_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the shear strength of a bonded joint on a test fixture.", "image_url": "https://picsum.photos/seed/tat_set58_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting trans-oceanic routes on a global navigation chart.", "image_url": "https://picsum.photos/seed/tat_set58_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged diaphragm on a pneumatic control valve.", "image_url": "https://picsum.photos/seed/tat_set58_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a mental health awareness session for college students.", "image_url": "https://picsum.photos/seed/tat_set58_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring elephant migration corridors using satellite collars.", "image_url": "https://picsum.photos/seed/tat_set58_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a digital soil compaction tester to check field readiness.", "image_url": "https://picsum.photos/seed/tat_set58_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring forklift utilization rates on a central dashboard.", "image_url": "https://picsum.photos/seed/tat_set58_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Vibrometer", "Bio-plastic", "River-ghat", "KUSUM", "Shear", "Trans-oceanic", "Diaphragm", "Mental-health", "Corridor", "Compaction", 
  ...
  "SRT": [
    "He is calibrating a digital vibrometer and the reading fluctuates wildly due to machine unbalance. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB trans-oceanic check. He...",
    "He discovers that a local shop is selling adulterated honey in unmarked jars. He...",
    "While attending a mental health session, he notices a short circuit in the projector wiring causing sparks. He...",
    "He is organizing a district weightlifting tournament and the main scoreboard fails during the final lift. He...",
    "He finds a lost leather bag containing a laptop and a hard drive lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel water purifier fails. He...",
    "A group of porcupines enters and damages the crops on his farm at night. He...",
    "He is traveling on a bus and the driver gets a sudden severe headache and loses focus. He...",
    "He is accused of cheating in a physics test that he had prepared well for. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set58/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital vibrometer on a rotating machine."
  },

  "PI": [
    "How do you handle a situation where a vibration measurement instrument fails during a testing project?",
    "Tell me about a time you led a team to clear plastic waste or clean up a river ghat or public space.",
    "What is your understanding of the strategic importance of bio-plastics in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the sale of adulterated honey or goods?",
    "What are the technical challenges in testing the shear strength of bonded joints?",
    "How do you handle a situation where you are falsely accused of cheating in a physics test?",
  ...
  "Lecturette": [
    "Bio-plastics: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like bio-plastics be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set58/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_58.json"), 'w', encoding='utf-8') as f:
    json.dump(set_58_data, f, indent=2)

print("Set 58 created successfully with CPSS.")
