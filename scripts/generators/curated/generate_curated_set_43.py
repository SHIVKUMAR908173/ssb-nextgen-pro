...
set_43_data = {
  "set_id": "SET_43",
  "description": "High-Quality Curated SSB Dataset - Set 43",
  "TAT": [
    {"pic_no": 1, "description": "A young technician aligning an infrared pyrometer scanner inside a high-temperature industrial kiln room.", "image_url": "https://picsum.photos/seed/tat_set43_1/800/600"},
    {"pic_no": 2, "description": "A research scientist checking pressure indicators on a carbon-reinforced liquid hydrogen storage vessel.", "image_url": "https://picsum.photos/seed/tat_set43_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets painting safety markings on a newly opened concrete mountain road barrier.", "image_url": "https://picsum.photos/seed/tat_set43_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining zero-interest agricultural micro-credit programs to rural women.", "image_url": "https://picsum.photos/seed/tat_set43_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector checking anchor bolts on a newly erected wind turbine tower base.", "image_url": "https://picsum.photos/seed/tat_set43_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet checking heading course plots on a military mission briefing table.", "image_url": "https://picsum.photos/seed/tat_set43_6/800/600"},
    {"pic_no": 7, "description": "A mechanic fitting replacement gear teeth onto a heavy-duty rotary drill head assembly.", "image_url": "https://picsum.photos/seed/tat_set43_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing primary sterile cotton rolls and antiseptic liquids at a rescue center.", "image_url": "https://picsum.photos/seed/tat_set43_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists anchoring bamboo mesh frames to stabilize a steep eroding mud slope.", "image_url": "https://picsum.photos/seed/tat_set43_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking sweet purple grapes in a terrace vineyard using a low rolling stool harness.", "image_url": "https://picsum.photos/seed/tat_set43_10/800/600"},
    {"pic_no": 11, "description": "A port dispatcher tracking container ship berths on a wide command-center console display.", "image_url": "https://picsum.photos/seed/tat_set43_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Pyrometer", "Hydrogen", "Barrier", "Micro-credit", "Anchor", "Briefing", "Drill-head", "Mesh", "Grapes", "Berths", 
  ...
  "SRT": [
    "He is leading a solar pyrometer installation team and a sudden severe sandstorm damages the optical cover. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB visual flight coordination check. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set43/800/600?blur=5",
    "description": "Hazy picture of a young technician aligning an infrared pyrometer scanner inside a high-temperature industrial kiln room."
  },

  "PI": [
    "How do you handle a project evaluator who sharply criticizes your materials selection in your final year project?",
    "Tell me about a time you organized a volunteer campaign to paint clear visibility markers on mountain road boundaries.",
    "What is your view on the strategic role of LEO satellite constellations in regional maritime security?",
    "How do you manage your physical training intensity during long periods of academic exams?",
    "Tell me about a time you stood up against unfair parking fee collection policies in your neighborhood.",
    "What are the key technical challenges in building high-capacity battery recycling plants?",
    "How do you resolve a resource bottleneck when two laboratory groups need the exact same testing press?",
    "Tell me about a time you successfully helped a teammate recover their focus after a major team task failure.",
    "If you are assigned to a team where the former coordinator works directly under you, how do you build mutual trust?",
    "What is your opinion on the strategic role of Baltic Sea offshore wind energy treaties?",
    "Tell me about a major family logistics task you completed during an unexpected local natural gas pipeline burst.",
    "What does group harmony mean to you when executing a complex suspended cantilever wooden bridge crossing?",
    "What is the significance of the motto 'Dedication and Discipline' in your personal academic routine?",
    "How do you handle a teammate who has high creative conceptualization skills but completely lacks structural realism?",
    "What role does emergency satellite telemetry play in mapping active forest fire progression lanes?",
    "Tell me about a time you volunteered to manage audience seating queues during a crowded college festival.",
    "What are your views on India's strategic partnership with East African littoral countries?",
    "If you are not selected, what backup options in autonomous drone dynamics or satellite communication systems will you pursue?",
    "How do you handle a roommate who repeatedly utilizes your personal study materials without your consent?",
    "What is the most challenging 200-kilometer bicycle expedition or sub-zero mountaineering camp you have completed?"
  ],
  ...
  "Lecturette": [
    "LEO Satellites: Strategic Advantages in Regional Maritime Security",
    "Battery Recycling: Key Technical and Environmental Challenges",
    "Baltic Sea Offshore Wind: Energy Treaties and Geopolitics",
    "Satellite Telemetry in Forest Fire Progression Tracking"
  ],

  "GD": [
    "Should the development of battery recycling and high-yield chemical extraction systems be funded exclusively by local public entities, or should private conglomerates be granted unlimited patent titles to accelerate development?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set43/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_43.json"), 'w', encoding='utf-8') as f:
    json.dump(set_43_data, f, indent=2)

print("Set 43 created successfully with CPSS.")
