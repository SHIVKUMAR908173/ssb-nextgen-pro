...
set_53_data = {
  "set_id": "SET_53",
  "description": "High-Quality Curated SSB Dataset - Set 53",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital pitot tube in a subsonic wind tunnel.", "image_url": "https://picsum.photos/seed/tat_set53_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a quantum dot light-emitting diode (QLED) film for advanced displays.", "image_url": "https://picsum.photos/seed/tat_set53_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing plastic waste and dry leaves from a local heritage park.", "image_url": "https://picsum.photos/seed/tat_set53_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining digital locker (DigiLocker) concepts and security to high school students.", "image_url": "https://picsum.photos/seed/tat_set53_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the fatigue limit of a metal coupon on a specialized test rig.", "image_url": "https://picsum.photos/seed/tat_set53_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting search and rescue patterns on a maritime navigation chart.", "image_url": "https://picsum.photos/seed/tat_set53_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged seal on a heavy-duty hydraulic cylinder.", "image_url": "https://picsum.photos/seed/tat_set53_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a career guidance and counseling seminar for village youth.", "image_url": "https://picsum.photos/seed/tat_set53_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring vulture populations using nest surveys in rocky cliffs.", "image_url": "https://picsum.photos/seed/tat_set53_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a digital tensiometer to measure soil water tension in an orchard.", "image_url": "https://picsum.photos/seed/tat_set53_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring cold chain temperature sensors on a central dashboard.", "image_url": "https://picsum.photos/seed/tat_set53_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Pitot-tube", "QLED", "Heritage-park", "DigiLocker", "Fatigue", "Search-rescue", "Seal", "Guidance", "Vulture", "Tensiometer", 
  ...
  "SRT": [
    "He is calibrating a digital pitot tube and the reading fluctuates wildly due to a blocked port. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB search and rescue check. He...",
    "He discovers that a local cold storage is leaking ammonia gas into the surrounding area. He...",
    "While attending a career guidance seminar, he notices a short circuit in the projector wiring causing sparks. He...",
    "He is organizing a district carrom tournament and the main scoreboard fails during the final match. He...",
    "He finds a lost bag containing original educational certificates lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel water heater fails in winter. He...",
    "A herd of wild boars enters and damages the crops on his farm at night. He...",
    "He is traveling on a highway bus and the driver suffers from a sudden panic attack and stops the bus. He...",
    "He is accused of cheating in a group project that he had contributed to significantly. He...",
    "He is coordinating a state hockey tournament and the referee refuses to continue due to aggressive protests by a team coach. He...",
    ...
    "He notices a local milk vendor mixing chemical powder in the milk before delivery. He...",
    "He gets caught in a sudden severe dust storm while riding a motorcycle on a remote highway route. He...",
    "He is selected to lead his university team in a national chess championship but his train ticket is not confirmed. He...",
    "He notices an illegal sand mining activity on the river bank behind his village. He...",
    "His project supervisor asks him to fabricate the structural load test reports of a beam prototype. He...",
    "A traffic police officer asks for a bribe to return his seized driving license. He...",
    ...
    "He is working in a chemistry lab and a vial containing a highly toxic chemical breaks, spilling across the floor. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set53/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital pitot tube in a subsonic wind tunnel."
  },

  "PI": [
    "How do you handle a situation where a pressure measurement instrument fails during a wind tunnel test?",
    "Tell me about a time you led a team to clear plastic waste or clean up a heritage park or public space.",
    "What is your understanding of the strategic importance of quantum dot technology in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the illegal discharge of ammonia or pollutants?",
    "What are the technical challenges in testing the fatigue limit of aerospace materials?",
    "How do you handle a situation where you are falsely accused of cheating in a group project?",
    "Tell me about a time you managed a medical emergency or provided first aid during an event.",
    "If you are put in a team with members who have a very casual attitude, how will you motivate them?",
    "What is your opinion on the strategic importance of the Indian Ocean region for India's security?",
    "Tell me about a major family logistics task you completed during an unexpected local power outage.",
    "What does team discipline mean to you when executing a complex obstacle task or a group project?",
    "What is the significance of the motto of your favorite sports team or organization in your life?",
    "How do you deal with a team member who is very knowledgeable but refuses to share information with others?",
    "How can satellite technology be used to monitor and prevent illegal sand mining in river beds?",
    "Tell me about a time you volunteered to manage the logistics of a large-scale event.",
    "What are your views on India's defense indigenization and the 'Make in India' initiative?",
    "If you are not recommended this time, what parallel careers in defense research or engineering will you pursue?",
    "How do you handle a situation where a colleague takes credit for your work in front of superiors?",
    "What is the most challenging 50-kilometer run or high-altitude trek you have completed?"
  ],
  ...
  "Lecturette": [
    "Quantum Dot Technology: Principles and Defense Applications",
    "Indian Ocean Region: Geopolitical and Strategic Importance for India",
    "Defense Indigenization: Challenges and the Way Forward",
    "Satellite Technology in Monitoring Illegal Mining"
  ],

  "GD": [
    "Should the development of advanced materials like quantum dots be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
    "Does the promotion of digital literacy in rural areas genuinely empower the youth, or does it merely accelerate migration to urban centers?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set53/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_53.json"), 'w', encoding='utf-8') as f:
    json.dump(set_53_data, f, indent=2)

print("Set 53 created successfully with CPSS.")
