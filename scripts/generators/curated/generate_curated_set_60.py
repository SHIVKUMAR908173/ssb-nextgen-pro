...
set_60_data = {
  "set_id": "SET_60",
  "description": "High-Quality Curated SSB Dataset - Set 60",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital tachometer on a high-speed motor.", "image_url": "https://picsum.photos/seed/tat_set60_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a metamaterial sample for radar absorption applications.", "image_url": "https://picsum.photos/seed/tat_set60_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing weeds from a neglected playground for village children.", "image_url": "https://picsum.photos/seed/tat_set60_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining Ayushman Bharat digital health ID concepts to elders.", "image_url": "https://picsum.photos/seed/tat_set60_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the acoustic absorption of a metamaterial panel.", "image_url": "https://picsum.photos/seed/tat_set60_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting terrain-following low-level routes on a radar chart.", "image_url": "https://picsum.photos/seed/tat_set60_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged slip ring on an alternator.", "image_url": "https://picsum.photos/seed/tat_set60_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a local clean-tech exhibition in a school.", "image_url": "https://picsum.photos/seed/tat_set60_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring slender loris populations using night vision cameras.", "image_url": "https://picsum.photos/seed/tat_set60_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a digital milk fat tester to check quality.", "image_url": "https://picsum.photos/seed/tat_set60_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring battery health of electric delivery vehicles on a dashboard.", "image_url": "https://picsum.photos/seed/tat_set60_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Tachometer", "Metamaterial", "Playground", "Ayushman", "Acoustic", "Terrain-following", "Slip-ring", "Clean-tech", "Slender-loris", "Milk-fat", 
  ...
  "SRT": [
    "He is calibrating a digital tachometer and the reading fluctuates wildly due to electrical noise. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB terrain plot check. He...",
    "He discovers that a local shop is selling adulterated milk in loose packets. He...",
    "While conducting a clean-tech exhibition, he notices a short circuit in the display lighting causing sparks. He...",
    "He is organizing a district table tennis tournament and the main referee refuses to continue due to a dispute. He...",
    "He finds a lost leather pouch containing gold ornaments lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel water supply fails. He...",
    "A pack of wild jackals attacks a poultry farm near the forest edge. He...",
    "He is traveling on a bus and the driver gets a sudden severe earache and loses focus. He...",
    "He is accused of cheating in a biology test that he had prepared well for. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set60/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital tachometer on a high-speed motor."
  },

  "PI": [
    "How do you handle a situation where a speed measurement instrument fails during a testing project?",
    "Tell me about a time you led a team to clear weeds or clean up a playground or public space.",
    "What is your understanding of the strategic importance of metamaterials in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the sale of adulterated milk or goods?",
    "What are the technical challenges in testing the acoustic absorption of metamaterials?",
    "How do you handle a situation where you are falsely accused of cheating in a biology test?",
  ...
  "Lecturette": [
    "Metamaterial Technology: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like metamaterials be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set60/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_60.json"), 'w', encoding='utf-8') as f:
    json.dump(set_60_data, f, indent=2)

print("Set 60 created successfully with CPSS.")
