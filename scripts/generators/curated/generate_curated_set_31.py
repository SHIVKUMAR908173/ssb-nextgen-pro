...
set_31_data = {
  "set_id": "SET_31",
  "description": "High-Quality Curated SSB Dataset - Set 31",
  "TAT": [
    {"pic_no": 1, "description": "A young technician installing a drone thermal imaging camera on a workbench in a research lab.", "image_url": "https://picsum.photos/seed/tat_set31_1/800/600"},
    {"pic_no": 2, "description": "A research meteorologist checking data feeds on a cluster of real-time weather monitoring screens.", "image_url": "https://picsum.photos/seed/tat_set31_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing invasive water hyacinth from a village irrigation channel.", "image_url": "https://picsum.photos/seed/tat_set31_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining digital health card benefits to village elders under a solar street light.", "image_url": "https://picsum.photos/seed/tat_set31_4/800/600"},
    {"pic_no": 5, "description": "A structural engineer inspecting cable stays on a newly constructed steel suspension bridge.", "image_url": "https://picsum.photos/seed/tat_set31_5/800/600"},
    {"pic_no": 6, "description": "An instructor demonstrating tactical fire positions to cadets on a sand table map layout.", "image_url": "https://picsum.photos/seed/tat_set31_6/800/600"},
    {"pic_no": 7, "description": "A flight technician replacing fuel pump manifold gaskets inside the engine bay of a twin-prop plane.", "image_url": "https://picsum.photos/seed/tat_set31_7/800/600"},
    {"pic_no": 8, "description": "A young woman delivering winter survival blankets and emergency food kits to disaster shelter residents.", "image_url": "https://picsum.photos/seed/tat_set31_8/800/600"},
    {"pic_no": 9, "description": "Two researchers placing concrete mesh panels to restore coral reefs in a tropical marine sanctuary.", "image_url": "https://picsum.photos/seed/tat_set31_9/800/600"},
    {"pic_no": 10, "description": "A worker picking fresh orange blossoms in an organic citrus grove using a mesh harness pole.", "image_url": "https://picsum.photos/seed/tat_set31_10/800/600"},
    {"pic_no": 11, "description": "A rescue coordinator directing emergency response vehicles on a real-time satellite screen.", "image_url": "https://picsum.photos/seed/tat_set31_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Thermal", "Cluster", "Hyacinth", "Solar", "Suspension", "Tactical", "Manifold", "Blanket", "Mesh", "Blossom", 
    "Direct", "Apex", "Bold", "Cope", "Drive", "Earn", "Firm", "Glow", "Hope", "Keen", 
  ...
  "SRT": [
    "He is leading a thermal imaging survey team and a sudden mountain snowstorm blocks their return path. He...",
    "His younger sister's university viva timing clashes with his crucial SSB pilot battery instrument exams. He...",
    "He discovers his neighbors are storing high-pressure industrial gas cylinders illegally near a dry brushwood fence. He...",
    "While traveling on a highway, he notices a high-voltage electrical pole cracked and leaning dangerously over a road. He...",
    "He is organizing a national software seminar and the primary server hosting the live coding console crashes. He...",
    "He finds a lost leather briefcase containing crucial land title records on a park bench. He...",
    "He is preparing for his final engineering exams but the neighbor's high-speed water pump runs all night. He...",
    "A swarm of wild wasps nests inside the battery bay of his solar irrigation pump, stopping water flow. He...",
    "He is traveling on a highway bus and the driver suffers from severe heat stroke on an isolated stretch. He...",
    "He is accused of copying a research database template that he had developed through weeks of testing. He...",
    "He is coordinating a state basketball league and the referee refuses to continue due to aggressive protests. He...",
    "He is stuck in a passenger lift with an elderly person who starts showing symptoms of severe panic. He...",
    "He notices a local gas vendor tampering with the safety valves of domestic cylinders before delivery. He...",
    "He gets caught in a sudden severe hailstorm while riding his motorcycle on a remote route. He...",
    "He is selected to lead his university team in a national athletics meet but his sports kit is lost. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set31/800/600?blur=5",
    "description": "Hazy picture of a young technician installing a drone thermal imaging camera on a workbench in a research lab."
  },

  "PI": [
    "How do you handle a teammate who consistently takes credit for group accomplishments?",
    "Tell me about a time you had to coordinate a large scale relief drive during a local emergency.",
    "What is your view on the strategic importance of the Andaman and Nicobar Command in Indo-Pacific security?",
    "How do you manage your concentration when preparing for multiple high-stakes exams simultaneously?",
    "Tell me about a time you had to stand up against systemic corruption in your organization.",
    ...
    "If you are not selected in this attempt, what backup careers in space technology or research have you considered?",
  ...
  "Lecturette": [
    "Andaman and Nicobar Command: Indo-Pacific Strategic Pivot",
    "Cyberwarfare: Challenges from State-Sponsored Actors",
    "Deep-Sea Mining: Geopolitical Implications",
    "The Distinction Between Physical Courage and Moral Courage"
  ],

  "GD": [
    "Should deep-sea mining be permitted under strict international guidelines, or is the threat to marine ecosystems too high?",
    "Does the rising popularity of digital micro-credentials undermine the value of traditional university degrees?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set31/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_31.json"), 'w', encoding='utf-8') as f:
    json.dump(set_31_data, f, indent=2)

print("Set 31 created successfully with CPSS.")
