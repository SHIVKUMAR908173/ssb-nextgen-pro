...
set_51_data = {
  "set_id": "SET_51",
  "description": "High-Quality Curated SSB Dataset - Set 51",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital lux meter in a modern greenhouse.", "image_url": "https://picsum.photos/seed/tat_set51_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a graphene oxide sheet for membrane applications.", "image_url": "https://picsum.photos/seed/tat_set51_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing thick silt and debris from a check dam.", "image_url": "https://picsum.photos/seed/tat_set51_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining PM-SYM (Shram Yogi Maan-dhan) scheme to unorganized workers.", "image_url": "https://picsum.photos/seed/tat_set51_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the deflection of a newly fabricated composite panel.", "image_url": "https://picsum.photos/seed/tat_set51_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting dead reckoning routes on a navigation log sheet.", "image_url": "https://picsum.photos/seed/tat_set51_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged chain drive on a large industrial conveyor.", "image_url": "https://picsum.photos/seed/tat_set51_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a cleanliness and book arrangement drive in a public library.", "image_url": "https://picsum.photos/seed/tat_set51_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring leopard movement using pugmarks and tracking in a reserve.", "image_url": "https://picsum.photos/seed/tat_set51_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a handheld chlorophyll meter to check the health of a crop.", "image_url": "https://picsum.photos/seed/tat_set51_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring automated guided vehicles (AGVs) on a warehouse screen.", "image_url": "https://picsum.photos/seed/tat_set51_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Lux-meter", "Graphene", "Check-dam", "Scheme", "Deflection", "Reckoning", "Chain-drive", "Library", "Pugmark", "Chlorophyll", 
  ...
  "SRT": [
    "He is calibrating a digital lux meter and it reads zero due to a faulty sensor connection. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB dead reckoning check. He...",
    "He discovers that a local farmer is using banned, highly toxic pesticides on vegetables. He...",
    "While reading in a library, he notices a short circuit in a reading lamp causing sparks. He...",
    "He is organizing a college badminton match and the main electronic scoreboard fails during the final set. He...",
    "He finds a lost mobile phone with banking SMS notifications visible lying on an airport bus seat. He...",
    "He is preparing for his competitive entrance exam but the hostel geyser fails in winter. He...",
    "A troop of wild monkeys attacks a school garden in his village. He...",
    "He is traveling on a highway bus and the driver gets a severe muscle cramp and stops the bus. He...",
    "He is accused of copying a lab record that he had prepared after conducting all experiments. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set51/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital lux meter in a modern greenhouse."
  },

  "PI": [
    "How do you handle a situation where a light measurement instrument fails during a greenhouse experiment?",
    "Tell me about a time you led a team to clear silt or clean up a check dam or water channel.",
    "What is your understanding of the strategic importance of graphene materials in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the use of banned pesticides or adulteration?",
    "What are the technical challenges in designing high-strength composite panels?",
    "How do you handle a situation where you are falsely accused of copying a lab record?",
  ...
  "GD": [
    "Should the development of advanced materials like graphene be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set51/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_51.json"), 'w', encoding='utf-8') as f:
    json.dump(set_51_data, f, indent=2)

print("Set 51 created successfully with CPSS.")
