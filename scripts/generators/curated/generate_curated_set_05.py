...
set_05_data = {
  "set_id": "SET_05",
  "description": "High-Quality Curated SSB Dataset - Set 5 (Without CPSS)",
  
  "TAT": [
    {"pic_no": 1, "description": "A doctor examining a young child while the mother looks on anxiously.", "image_url": "https://picsum.photos/seed/tat_set5_1/800/600"},
    {"pic_no": 2, "description": "A young athlete looking intensely at a gold trophy placed on a table.", "image_url": "https://picsum.photos/seed/tat_set5_2/800/600"},
    {"pic_no": 3, "description": "A soldier sitting in a dimly lit bunker, writing a letter.", "image_url": "https://picsum.photos/seed/tat_set5_3/800/600"},
    {"pic_no": 4, "description": "A group of workers trying to stop a large leak from an industrial pipe.", "image_url": "https://picsum.photos/seed/tat_set5_4/800/600"},
    {"pic_no": 5, "description": "Two individuals shaking hands while a third person watches them angrily.", "image_url": "https://picsum.photos/seed/tat_set5_5/800/600"},
    {"pic_no": 6, "description": "A person standing at the edge of a diving board, looking down.", "image_url": "https://picsum.photos/seed/tat_set5_6/800/600"},
    {"pic_no": 7, "description": "A young man helping a mechanic fix a heavy truck engine.", "image_url": "https://picsum.photos/seed/tat_set5_7/800/600"},
    {"pic_no": 8, "description": "A group of people sitting in a circle in a forest, having a serious discussion.", "image_url": "https://picsum.photos/seed/tat_set5_8/800/600"},
    {"pic_no": 9, "description": "A woman confidently addressing a boardroom full of older executives.", "image_url": "https://picsum.photos/seed/tat_set5_9/800/600"},
    {"pic_no": 10, "description": "A boy carrying a heavy stack of books dropping some of them on the stairs.", "image_url": "https://picsum.photos/seed/tat_set5_10/800/600"},
    {"pic_no": 11, "description": "A person looking through binoculars from a watchtower.", "image_url": "https://picsum.photos/seed/tat_set5_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Start", "Stop", "Learn", "Teach", "Read", "Write", "Sing", "Art", "Paint", "Color",
    "Draw", "Build", "Machine", "Tech", "Code", "Program", "Engine", "Drive", "Fly", "Pilot",
    "Sail", "Boat", "Ship", "Port", "Harbor", "Sea", "Sand", "Beach", "Shell", "Pearl",
    "Gem", "Gold", "Silver", "Iron", "Steel", "Metal", "Hard", "Soft", "Rough", "Even",
    "Odd", "Number", "Math", "Logic", "Reason", "Debate", "Argue", "Fight", "Peace", "Treaty",
    "Pact", "Promise", "Vow", "Oath", "Swear", "Honor", "Duty", "Pride", "Shame", "Regret"
  ],

  "SRT": [
    "He is the organizer of a blood donation camp, but the medical team fails to arrive on time. He...",
    "While returning from a trip, he realizes he left his laptop containing critical office data at the hotel 200 km away. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set5/800/600?blur=5",
    "description": "Hazy picture of a group of people pulling a heavy rope in what looks like a tug-of-war or rescue."
  },

  "PI": [
    "Tell me about a time when you had to manage a highly emotional situation.",
    "If you could learn any one new skill overnight, what would it be and why?",
    "How do you handle individuals who don't pull their weight in a team?",
    "Describe a time when you had to adapt to a completely new environment.",
    "What are your views on the rapid growth of AI and deepfakes?",
    "Tell me about a time you had to stand up for something you believed was right, even when it was unpopular.",
    "What do you consider to be your greatest achievement so far?",
    "How do you deal with someone who constantly criticizes your work?",
    "If you are selected for the Army but get a desk job instead of combat, how would you react?",
    "What is your opinion on the startup ecosystem in India?",
    "Tell me about your most embarrassing moment and what you learned from it.",
    "How do you balance your personal life and professional/academic responsibilities?",
    "What role do your friends play in your life?",
    "Describe a situation where you had to quickly learn a lot of information.",
    "What are your views on the increasing plastic pollution and its solutions?",
    "If you could travel back in time, what advice would you give your 15-year-old self?",
    "How do you react when your plans suddenly change due to external factors?",
    "What is the most common feedback you receive from your parents?",
    "Tell me about a time you mediated a conflict between two friends.",
    "Why do you think discipline is considered the backbone of the Armed Forces?"
  ],
  ...
  "Lecturette": [
    ...
    "Start-up India: Challenges and Opportunities",
    "Plastic Pollution: A Global Crisis"
  ],

  "GD": [
    "One Nation One Election: Feasible in a diverse country like India?",
    "Impact of reality television shows on the mindset of youth."
  ],

  "GPE": {
    "narrative": "You are a group of 6 veterinary students visiting a wildlife sanctuary on an island. It is 1600 hours. A local boatman runs to you and says: 1. A tourist ferry has hit a rock 2 km offshore and is slowly sinking. 2. A batch of highly temperature-sensitive vaccines needs to be delivered to the mainland hospital (10 km away) before 1730 hours, or they will spoil. 3. A rare leopard has been severely injured by a poacher trap in the jungle 3 km inland. 4. A massive storm is predicted to hit the island at 1700 hours, which will stop all boat movement. You have one motorboat (seats 4), one jeep, basic medical kits, and ropes. The mainland police station is 12 km away. How will you coordinate your team to handle these critical emergencies before the storm hits?",
    "map_url": "https://picsum.photos/seed/gpe_map_set5/800/600"
  },

  "GTO": {
    "PGT": "Progressive Group Task: 4 progressive obstacles emphasizing balancing over narrow gaps. Resources: 1 long Plank, 1 short Balli, 2 Ropes. Time: 45 mins. Strict 'no touching red' rules.",
...
with open(os.path.join(OUTPUT_DIR, "set_05.json"), 'w', encoding='utf-8') as f:
    json.dump(set_05_data, f, indent=2)

print("Set 5 created successfully without CPSS.")
