...
set_33_data = {
  "set_id": "SET_33",
  "description": "High-Quality Curated SSB Dataset - Set 33",
  "TAT": [
    {"pic_no": 1, "description": "A young technician repairing a solar-powered drip irrigation system in a dry agricultural field.", "image_url": "https://picsum.photos/seed/tat_set33_1/800/600"},
    {"pic_no": 2, "description": "A research scientist checking the calibration of an optical spectrometer inside a physics lab.", "image_url": "https://picsum.photos/seed/tat_set33_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing dry pine needles to prevent forest fires along a mountain track.", "image_url": "https://picsum.photos/seed/tat_set33_3/800/600"},
    {"pic_no": 4, "description": "A volunteer explaining mobile banking safety measures to village elders in a community center.", "image_url": "https://picsum.photos/seed/tat_set33_4/800/600"},
    {"pic_no": 5, "description": "A structural engineer inspecting cable connections on a newly built telecommunications mast.", "image_url": "https://picsum.photos/seed/tat_set33_5/800/600"},
    {"pic_no": 6, "description": "An instructor showing tactical search flight routes to young cadets on a global planning map.", "image_url": "https://picsum.photos/seed/tat_set33_6/800/600"},
    {"pic_no": 7, "description": "A mechanic adjusting the high-torque planetary gears of a combine harvester in a workshop.", "image_url": "https://picsum.photos/seed/tat_set33_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer delivering warm winter clothing and primary health kits to a local shelter.", "image_url": "https://picsum.photos/seed/tat_set33_8/800/600"},
    {"pic_no": 9, "description": "Two researchers placing artificial concrete reef structures to restore oyster beds in a bay.", "image_url": "https://picsum.photos/seed/tat_set33_9/800/600"},
    {"pic_no": 10, "description": "A worker picking fresh mangoes in an organic orchard using a mesh harvest pole with a blade.", "image_url": "https://picsum.photos/seed/tat_set33_10/800/600"},
    {"pic_no": 11, "description": "A control center coordinator tracking emergency fleet dispatch vehicles on a large digital map.", "image_url": "https://picsum.photos/seed/tat_set33_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Irrigation", "Spectrometer", "Needles", "Mobile", "Mast", "Planning", "Planetary", "Clothing", "Reef", "Mangoes", 
  ...
  "SRT": [
    "He is leading an irrigation system setup team and a sudden heavy leakage floods the main control room. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB physical agility test. He...",
    "He discovers his neighbors are storing large quantities of industrial chemical solvent illegally in their backyard. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set33/800/600?blur=5",
    "description": "Hazy picture of a young technician repairing a solar-powered drip irrigation system in a dry agricultural field."
  },

  "PI": [
    "How do you handle a supervisor who consistently gives vague or contradictory instructions?",
    "Tell me about a time you organized a volunteer campaign to plant trees along urban highways.",
    "What is your view on the strategic challenge of submarine-launched ballistic missiles in deterrence?",
    "How do you manage your sleep schedule and physical recovery during intense training camps?",
    "Tell me about a time you took a stand against an unethical practice in your university sports club.",
    "What are the main differences between hyper-spectral imaging satellites and optical observation satellites?",
    "How do you handle a group member who insists on using obsolete tools or techniques for a project?",
    "Tell me about a time you successfully negotiated a budget or resource dispute between student factions.",
    "If you are assigned to a newly created team with no clear hierarchy or leadership, how do you take charge?",
    "What is your opinion on the strategic role of the Northern Sea Route in global trade and politics?",
    "Tell me about a major family challenge where you had to manage the logistics of a relative's long-term medical care.",
    "What does the term 'intellectual humility' mean to you in the context of team decisions?",
    "What is the significance of the motto 'Duty, Honour, Courage' in your daily academic life?",
    "How do you deal with a brilliant team member who is highly unorganized and misses deadlines?",
    "What role does logistics and supply chain management play in winning modern conflicts?",
    "Tell me about a time you volunteered to manage waste recycling during a large college festival.",
    "What are your views on India's strategic relations with East African maritime nations?",
    "If you are not selected, what specific technical certifications will you pursue next?",
    "How do you handle a colleague who constantly interrupts others during team meetings?",
    "What is the most challenging hiking expedition or long-distance trek you have ever completed?"
  ],
  ...
  "Lecturette": [
    "Submarine-Launched Ballistic Missiles (SLBMs) and Global Deterrence",
    "Hyper-Spectral Imaging Satellites: Applications and Capabilities",
    "Northern Sea Route: Geopolitical and Trade Pivot",
    "The Concept and Importance of Intellectual Humility in Leadership"
  ],

  "GD": [
    "Should the Northern Sea Route be internationalized under joint supervision, or should the sovereign claims of Arctic nations be prioritized?",
    "Does the growth of decentralized autonomous organizations (DAOs) represent the future of professional work, or is it an unstable model?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set33/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_33.json"), 'w', encoding='utf-8') as f:
    json.dump(set_33_data, f, indent=2)

print("Set 33 created successfully with CPSS.")
