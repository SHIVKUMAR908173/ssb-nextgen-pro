...
set_47_data = {
  "set_id": "SET_47",
  "description": "High-Quality Curated SSB Dataset - Set 47",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a spectrophotometer in a high-precision chemical laboratory.", "image_url": "https://picsum.photos/seed/tat_set47_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a piezoelectric polymer film for smart sensor applications.", "image_url": "https://picsum.photos/seed/tat_set47_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing thick silt from a blocked drainage canal in a village.", "image_url": "https://picsum.photos/seed/tat_set47_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining financial literacy and savings schemes to rural artisans.", "image_url": "https://picsum.photos/seed/tat_set47_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the vibration levels of a heavy machinery foundation.", "image_url": "https://picsum.photos/seed/tat_set47_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting fuel-efficient flight paths on a digital route planner.", "image_url": "https://picsum.photos/seed/tat_set47_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged gear on a complex planetary gearbox assembly.", "image_url": "https://picsum.photos/seed/tat_set47_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing oral rehydration salts (ORS) packets in a summer camp.", "image_url": "https://picsum.photos/seed/tat_set47_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring coral bleaching on a reef using an underwater drone.", "image_url": "https://picsum.photos/seed/tat_set47_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a leaf color chart to determine the nitrogen fertilizer needs of a crop.", "image_url": "https://picsum.photos/seed/tat_set47_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring rail freight movements on a regional network map.", "image_url": "https://picsum.photos/seed/tat_set47_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Spectrophotometer", "Piezoelectric", "Silt", "Literacy", "Vibration", "Fuel-efficient", "Planetary", "Rehydration", "Bleaching", "Chart", 
  ...
  "SRT": [
    "He is calibrating a spectrophotometer and the reading fluctuates wildly due to a faulty lamp. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB fuel-efficient route plotting check. He...",
    "He discovers that a local battery shop is disposing of used acid into the open street drain. He...",
    "While walking home, he notices a short circuit in a street decoration light pole causing sparks near dry leaves. He...",
    "He is organizing a district swimming gala and the main electronic timer fails during the final race. He...",
    "He finds a lost briefcase containing design blueprints of a bridge lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel mess serves stale food, causing him stomach upset. He...",
    "A swarm of wild bees attacks the visitors at a local flower show he is volunteering at. He...",
    "He is traveling on a bus and the driver faints due to a sudden cardiac arrest on a busy flyover. He...",
    "He is accused of plagiarizing a project report that he had written after extensive field surveys. He...",
    ...
    "He notices a local grocery shop selling expired food items with tampered date labels. He...",
    "He gets caught in a sudden severe hailstorm while riding a motorcycle on a remote highway route. He...",
    "He is selected to lead his university team in a national debate championship but his train ticket is lost. He...",
    "He notices an illegal construction activity on the bank of a protected lake behind his village. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set47/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a spectrophotometer in a high-precision chemical laboratory."
  },

  "PI": [
    "How do you handle a situation where a laboratory equipment fails during a critical time-bound project?",
    "Tell me about a time you led a team to clear silt or clean up a blocked water channel.",
    "What is your understanding of the strategic importance of piezoelectric materials in defense?",
    "How do you manage your time between academic studies and preparation for SSB?",
    "Have you ever reported or taken action against the sale of expired or adulterated goods?",
    "What are the engineering challenges in designing high-speed planetary gearboxes?",
    "How do you handle a situation where you are falsely accused of plagiarism or copying?",
    "Tell me about a time you managed a medical crisis or provided first aid during an event.",
  ...
  "Lecturette": [
    "Piezoelectric Materials: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like piezoelectric polymers be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
    "Does the promotion of financial literacy in rural areas genuinely empower the youth, or does it merely accelerate migration to urban centers?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set47/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_47.json"), 'w', encoding='utf-8') as f:
    json.dump(set_47_data, f, indent=2)

print("Set 47 created successfully with CPSS.")
