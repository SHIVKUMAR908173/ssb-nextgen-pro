...
set_39_data = {
  "set_id": "SET_39",
  "description": "High-Quality Curated SSB Dataset - Set 39",
  "TAT": [
    {"pic_no": 1, "description": "A young technician installing a solar-powered meteorological anemometer on a high tower.", "image_url": "https://picsum.photos/seed/tat_set39_1/800/600"},
    {"pic_no": 2, "description": "A research scientist adjusting the cooling line of a liquid helium cryostage bench.", "image_url": "https://picsum.photos/seed/tat_set39_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets placing stone gabions to protect a riverbank from monsoon erosion.", "image_url": "https://picsum.photos/seed/tat_set39_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer teaching online banking cyber hygiene to local auto-rickshaw drivers.", "image_url": "https://picsum.photos/seed/tat_set39_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector checking tension bolts on a high-tension electrical pylon tower.", "image_url": "https://picsum.photos/seed/tat_set39_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting air patrol surveillance routes on a coastal radar chart overlay.", "image_url": "https://picsum.photos/seed/tat_set39_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a double-acting hydraulic actuator on a front-loader vehicle.", "image_url": "https://picsum.photos/seed/tat_set39_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing non-perishable food bags and emergency thermal blankets in a shelter.", "image_url": "https://picsum.photos/seed/tat_set39_8/800/600"},
    {"pic_no": 9, "description": "Two researchers placing concrete tetrapod models to build a storm surge breakwater.", "image_url": "https://picsum.photos/seed/tat_set39_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking fresh sweet limes in an organic grove using an adjustable long clipper pole.", "image_url": "https://picsum.photos/seed/tat_set39_10/800/600"},
    {"pic_no": 11, "description": "A coordinator charting urgent logistics vessel arrivals on an interactive port dashboard.", "image_url": "https://picsum.photos/seed/tat_set39_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Anemometer", "Cryostage", "Gabions", "Rickshaw", "Pylon", "Surveillance", "Actuator", "Thermal", "Tetrapod", "Grove", 
    "Vessel", "Apex", "Bold", "Cope", "Drive", "Earn", "Firm", "Glow", "Hope", "Keen", 
  ...
  "SRT": [
    "He is leading a solar weather station installation team and a sudden lightning strike damages the anemometer unit. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB pilot dexterity assessment. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set39/800/600?blur=5",
    "description": "Hazy picture of a young technician installing a solar-powered meteorological anemometer on a high tower."
  },

  "PI": [
    "How do you handle a senior instructor who frequently provides conflicting tactical safety advice?",
    "Tell me about a time you volunteered to coordinate a neighborhood rainwater harvesting survey.",
    "What is your view on the military applications of passive phased array radar platforms?",
    "How do you manage your physical training performance under dense high-humidity forest climates?",
    "Tell me about a time you stood up against biased grade evaluations in your high school sports league.",
    "What are the key technical hurdles in building low-Earth-orbit (LEO) satellite internet constellations?",
    "How do you resolve a computing resources bottleneck during a high-speed hackathon?",
    "Tell me about a time you successfully helped a classmate recover their confidence after a failed semester test.",
    "If you are assigned to a team where the supervisor is completely unsupportive of new methods, how do you handle it?",
    "What is your opinion on the strategic significance of the Southern Ocean marine sanctuary regulations?",
    "Tell me about a major community logistics task you completed during a sudden local water shortage.",
    "What does team agility mean to you when executing a complex ground rescue simulation?",
    "What is the significance of the motto 'Duty and Determination' in your everyday life?",
    "How do you handle a co-cadet who has high physical stamina but completely lacks structural discipline?",
    "What role does emergency satellite telecommunication play in high-altitude earthquake responses?",
    "Tell me about a time you volunteered to manage traffic safety during a school cycle marathon.",
    "What are your views on India's strategic partnership with Central Asian landlocked nations?",
    "If you are not selected, what master's programs in satellite data processing or orbital dynamics have you considered?",
    "How do you handle a teammate who continuously copies your structural CAD design drawings?",
    "What is the most challenging 100-kilometer cycle race or mountain trail run you have successfully finished?"
  ],
  ...
  "Lecturette": [
    "Passive Phased Array Radars: Detection Capabilities",
    "LEO Satellite Internet Constellations: Strategic Hurdles",
    "Southern Ocean Marine Sanctuaries: Ecological Significance",
    "Satellite Telecommunications in Earthquake Relief Responses"
  ],

  "GD": [
    "Should high-yield agricultural biotechnology and genetically modified seed distributions be controlled exclusively by local public entities, or should private conglomerates be granted unlimited patent rights to encourage capital investments?",
    "Does the rapid digitization of land registration records using blockchain architecture reduce administrative corruption, or does it merely lead to systemic digital exclusion of rural populations?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set39/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_39.json"), 'w', encoding='utf-8') as f:
    json.dump(set_39_data, f, indent=2)

print("Set 39 created successfully with CPSS.")
