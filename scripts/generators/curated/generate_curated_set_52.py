...
set_52_data = {
  "set_id": "SET_52",
  "description": "High-Quality Curated SSB Dataset - Set 52",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital sound level meter in a recording studio.", "image_url": "https://picsum.photos/seed/tat_set52_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a high-temperature superconductor tape for power grid applications.", "image_url": "https://picsum.photos/seed/tat_set52_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing heavy debris and fallen rocks from a mountain trail.", "image_url": "https://picsum.photos/seed/tat_set52_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining PM-JAY health insurance cards and benefits to villagers.", "image_url": "https://picsum.photos/seed/tat_set52_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the resonance frequency of a bridge model.", "image_url": "https://picsum.photos/seed/tat_set52_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting instrument flight rules (IFR) routes on an enroute chart.", "image_url": "https://picsum.photos/seed/tat_set52_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged valve on a large hydraulic press.", "image_url": "https://picsum.photos/seed/tat_set52_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing an adult literacy class in a community hall.", "image_url": "https://picsum.photos/seed/tat_set52_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring sea turtle nesting activity using tag recovery on a beach.", "image_url": "https://picsum.photos/seed/tat_set52_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a handheld digital rain gauge to check rainfall data.", "image_url": "https://picsum.photos/seed/tat_set52_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring drone delivery flight paths on a central console.", "image_url": "https://picsum.photos/seed/tat_set52_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Sound-meter", "Superconductor", "Debris", "Insurance", "Resonance", "IFR-route", "Hydraulic", "Literacy", "Nesting", "Rain-gauge", 
  ...
  "SRT": [
    "He is calibrating a digital sound level meter and the reading fluctuates wildly due to background noise. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB IFR route check. He...",
    "He discovers that a local shop is selling adulterated cooking oil in unmarked containers. He...",
    "While walking near a community hall, he notices a short circuit in an external light fitting causing sparks. He...",
    "He is organizing a district table tennis tournament and the main electronic scoreboard fails during the final match. He...",
    "He finds a lost folder containing tax documents and identity cards lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but several hostel students fall ill due to food poisoning. He...",
    "A group of wild snakes enters the campsite of his trekking group at night. He...",
    "He is traveling on a mountain bus and the driver loses control on a steep slope. He...",
    "He is accused of leaking exam questions that he had no access to. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set52/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital sound level meter in a recording studio."
  },

  "PI": [
    "How do you handle a situation where a measurement instrument gives fluctuating readings due to environmental factors?",
    "Tell me about a time you led a team to clear debris or clean up a mountain trail or public path.",
    "What is your understanding of the strategic importance of superconductors in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the sale of adulterated food or spurious goods?",
    "What are the technical challenges in testing the resonance frequency of structures?",
    "How do you handle a situation where you are falsely accused of leaking confidential info or questions?",
  ...
  "Lecturette": [
    "Superconductors: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like superconductors be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set52/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_52.json"), 'w', encoding='utf-8') as f:
    json.dump(set_52_data, f, indent=2)

print("Set 52 created successfully with CPSS.")
