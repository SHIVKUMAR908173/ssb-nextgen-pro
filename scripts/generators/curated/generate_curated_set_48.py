...
set_48_data = {
  "set_id": "SET_48",
  "description": "High-Quality Curated SSB Dataset - Set 48",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a refractometer in a food quality testing laboratory.", "image_url": "https://picsum.photos/seed/tat_set48_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting an aerogel insulation blanket for a cryogenic tank.", "image_url": "https://picsum.photos/seed/tat_set48_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing thick weeds and debris from a historical stepwell.", "image_url": "https://picsum.photos/seed/tat_set48_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining digital health cards and their benefits to rural residents.", "image_url": "https://picsum.photos/seed/tat_set48_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the alignment of a large optical telescope mount.", "image_url": "https://picsum.photos/seed/tat_set48_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting visual approach paths on a detailed terrain map.", "image_url": "https://picsum.photos/seed/tat_set48_6/800/600"},
    {"pic_no": 7, "description": "A mechanic replacing a worn main bearing on a large wind turbine shaft.", "image_url": "https://picsum.photos/seed/tat_set48_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a basic first-aid and CPR training session in a community center.", "image_url": "https://picsum.photos/seed/tat_set48_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring wildlife movement using camera traps in a forest.", "image_url": "https://picsum.photos/seed/tat_set48_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a soil pH tester probe to check the acidity of a field.", "image_url": "https://picsum.photos/seed/tat_set48_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring container ship loading operations on a crane console.", "image_url": "https://picsum.photos/seed/tat_set48_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Refractometer", "Aerogel", "Stepwell", "Health-card", "Alignment", "Terrain", "Bearing", "First-aid", "Camera-trap", "Acidity", 
  ...
  "SRT": [
    "He is calibrating a refractometer and the reading fluctuates wildly due to a faulty prism. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB terrain mapping check. He...",
    ...
    "He is preparing for his competitive entrance exam but the hostel water supply is cut off. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set48/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a refractometer in a food quality testing laboratory."
  },

  "PI": [
    "How do you handle a situation where a testing instrument gives inconsistent readings during a project?",
    "Tell me about a time you led a team to clean up or restore a neglected historical site or public space.",
    "What is your understanding of the strategic importance of aerogel materials in aerospace applications?",
    ...
    "What are the technical challenges in aligning large optical systems like telescopes?",
  ...
  "Lecturette": [
    "Aerogel: The Miracle Material and its Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like aerogels be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set48/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_48.json"), 'w', encoding='utf-8') as f:
    json.dump(set_48_data, f, indent=2)

print("Set 48 created successfully with CPSS.")
