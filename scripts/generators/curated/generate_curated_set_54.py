...
set_54_data = {
  "set_id": "SET_54",
  "description": "High-Quality Curated SSB Dataset - Set 54",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital colorimeter in a textile dye house.", "image_url": "https://picsum.photos/seed/tat_set54_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a CFRP panel for defects using ultrasound.", "image_url": "https://picsum.photos/seed/tat_set54_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing weeds and leveling a neglected village sports field.", "image_url": "https://picsum.photos/seed/tat_set54_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining E-Shram card benefits and insurance to construction workers.", "image_url": "https://picsum.photos/seed/tat_set54_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the impact strength of a new composite helmet shell.", "image_url": "https://picsum.photos/seed/tat_set54_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting low-level tactical routes on a low-altitude chart.", "image_url": "https://picsum.photos/seed/tat_set54_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged universal joint on a heavy vehicle drive shaft.", "image_url": "https://picsum.photos/seed/tat_set54_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a self-defense workshop for school girls in a village.", "image_url": "https://picsum.photos/seed/tat_set54_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring gharial populations using basking surveys in a river.", "image_url": "https://picsum.photos/seed/tat_set54_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a handheld brix refractometer to check sugarcane ripeness.", "image_url": "https://picsum.photos/seed/tat_set54_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring fleet fuel efficiency and idling on a central screen.", "image_url": "https://picsum.photos/seed/tat_set54_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Colorimeter", "CFRP", "Sports-field", "E-Shram", "Impact", "Tactical", "Universal-joint", "Self-defense", "Gharial", "Brix", 
  ...
  "SRT": [
    "He is calibrating a digital colorimeter and the reading fluctuates wildly due to a faulty lamp. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB tactical route check. He...",
    "He discovers that a local shop is selling adulterated fertilizer in unmarked bags. He...",
    "While attending a self-defense workshop, he notices a short circuit in the sound system causing sparks. He...",
    "He is organizing a district kho-kho tournament and the main scoreboard fails during the final match. He...",
    "He finds a lost smartphone with active social media profiles open lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel water cooler stops working in peak summer. He...",
    "A herd of wild elephants enters and damages the crops on his farm at night. He...",
    "He is traveling on a highway bus and the driver gets a severe fit of coughing and stops the bus. He...",
    "He is accused of cheating in a project presentation that he had prepared with his team. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set54/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital colorimeter in a textile dye house."
  },

  "PI": [
    "How do you handle a situation where a color measurement instrument fails during a dye house project?",
    "Tell me about a time you led a team to clear weeds or level a sports field or public space.",
    "What is your understanding of the strategic importance of CFRP materials in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the sale of adulterated fertilizer or goods?",
    "What are the technical challenges in testing the impact strength of composite materials?",
    "How do you handle a situation where you are falsely accused of cheating in a project presentation?",
  ...
  "Lecturette": [
    "CFRP Materials: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like CFRP be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set54/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_54.json"), 'w', encoding='utf-8') as f:
    json.dump(set_54_data, f, indent=2)

print("Set 54 created successfully with CPSS.")
