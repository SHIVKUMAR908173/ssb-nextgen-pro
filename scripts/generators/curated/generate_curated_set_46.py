...
set_46_data = {
  "set_id": "SET_46",
  "description": "High-Quality Curated SSB Dataset - Set 46",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital theodolite on a high-altitude construction site.", "image_url": "https://picsum.photos/seed/tat_set46_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a superhydrophobic coating on a ship hull model in a water tank.", "image_url": "https://picsum.photos/seed/tat_set46_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing thick water hyacinth from a local village pond.", "image_url": "https://picsum.photos/seed/tat_set46_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer teaching basic block-based coding to school children in a rural community center.", "image_url": "https://picsum.photos/seed/tat_set46_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the load capacity of a newly fabricated steel truss bridge segment.", "image_url": "https://picsum.photos/seed/tat_set46_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting weather avoidance routes on a weather radar display.", "image_url": "https://picsum.photos/seed/tat_set46_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged impeller on a large centrifugal water pump.", "image_url": "https://picsum.photos/seed/tat_set46_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a health check-up camp for sanitation workers in the city.", "image_url": "https://picsum.photos/seed/tat_set46_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists tagging sea turtles on a nesting beach at night for research.", "image_url": "https://picsum.photos/seed/tat_set46_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a soil moisture sensor probe to determine optimal irrigation in a field.", "image_url": "https://picsum.photos/seed/tat_set46_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring cargo ship arrivals on a port radar console.", "image_url": "https://picsum.photos/seed/tat_set46_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Theodolite", "Coating", "Hyacinth", "Coding", "Truss", "Avoidance", "Impeller", "Sanitation", "Tagging", "Probe", 
  ...
  "SRT": [
    "He is calibrating a digital theodolite and the lens shatters due to a fall. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB weather avoidance plotting check. He...",
    "He discovers that a local shop is selling pesticide in unmarked, leaking containers. He...",
    "While walking in a park, he notices a short circuit in the water fountain pump causing sparks. He...",
    "He is organizing a district debate competition and the main scoreboard displays incorrect results due to a software bug. He...",
    "He finds a lost laptop bag containing sensitive corporate data lying on an airport bus seat. He...",
    "He is preparing for his competitive entrance exam but the hostel roof starts leaking heavily during rain, soaking his books. He...",
    "A troop of wild monkeys attacks the food storeroom of his camp. He...",
    "He is traveling on a train and the locomotive driver faints due to a sudden medical emergency. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set46/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital theodolite on a high-altitude construction site."
  },

  "PI": [
    "How do you handle a situation where your surveyor instrument fails in the middle of a crucial project?",
    "Tell me about a time you led a team to clear water hyacinth or invasive plants from a water body.",
    "What is your view on the strategic importance of superhydrophobic coatings in naval applications?",
    "How do you balance your training for SSB with your university exam schedule?",
    "Have you ever exposed or stood up against illegal mining or encroachment activities?",
    "What are the technical challenges in constructing large-span steel truss bridges?",
    "How do you handle a situation where a key resource for a project is stolen or lost?",
    "Tell me about a time you managed a medical emergency for a coworker or a classmate.",
    "If you are assigned a team member who is much older and more experienced than you, how will you lead them?",
    "What is your opinion on the strategic role of Arctic shipping routes in the future?",
    "Tell me about a major family logistics task you completed during an unexpected local natural disaster.",
    "What does team coordination mean to you when executing a complex river crossing or obstacle task?",
    "What is the significance of the motto of your school or college in your life?",
    "How do you handle a teammate who is highly critical of everyone's work but doesn't contribute themselves?",
    "What role does satellite telemetry play in tracking and predicting severe cyclonic storms?",
    ...
    "If you are not selected this time, what parallel careers in defense research or engineering will you pursue?",
  ...
  "Lecturette": [
    "Superhydrophobic Coatings: Principles and Defense Applications",
    "Arctic Shipping Routes: Geopolitical and Environmental Implications",
    "Defense Indigenization: Challenges and the Way Forward",
    "Satellite Technology in Severe Cyclone Prediction"
  ],

  "GD": [
    "Should the development of advanced defense coatings and materials be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set46/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_46.json"), 'w', encoding='utf-8') as f:
    json.dump(set_46_data, f, indent=2)

print("Set 46 created successfully with CPSS.")
