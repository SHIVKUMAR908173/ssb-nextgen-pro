...
set_59_data = {
  "set_id": "SET_59",
  "description": "High-Quality Curated SSB Dataset - Set 59",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital pyrometer in a high-temperature furnace room.", "image_url": "https://picsum.photos/seed/tat_set59_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a quantum dot film for advanced display applications.", "image_url": "https://picsum.photos/seed/tat_set59_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets painting the boundary walls of a village community health center.", "image_url": "https://picsum.photos/seed/tat_set59_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining PM-Awas Yojana benefits and housing loans to a rural family.", "image_url": "https://picsum.photos/seed/tat_set59_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the creep resistance of a high-temperature alloy beam.", "image_url": "https://picsum.photos/seed/tat_set59_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting supersonic cruise trajectories on a tactical flight chart.", "image_url": "https://picsum.photos/seed/tat_set59_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged bellows on a high-voltage vacuum interrupter.", "image_url": "https://picsum.photos/seed/tat_set59_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a road safety awareness drive using driving simulations.", "image_url": "https://picsum.photos/seed/tat_set59_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring Great Indian Bustard habitats using thermal cameras.", "image_url": "https://picsum.photos/seed/tat_set59_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a digital grain moisture meter to check harvest readiness.", "image_url": "https://picsum.photos/seed/tat_set59_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring dock door turnaround times on a live dashboard.", "image_url": "https://picsum.photos/seed/tat_set59_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Pyrometer", "Quantum-dot", "Health-center", "Awas-Yojana", "Creep", "Supersonic", "Interrupter", "Road-safety", "Bustard", "Grain-moisture", 
  ...
  "SRT": [
    "He is calibrating a digital pyrometer and the reading fluctuates wildly due to furnace heat radiation. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB supersonic plot check. He...",
    "He discovers that a local shop is selling adulterated spices in loose packets. He...",
    "While conducting a road safety drive, he notices a short circuit in the simulation system causing sparks. He...",
    "He is organizing a district badminton tournament and the main referee refuses to continue due to a dispute. He...",
    "He finds a lost briefcase containing a cheque book and cash lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel mess food quality fails drastically. He...",
    "A group of wild monkeys attacks a fruit vendor near the school gate. He...",
    "He is traveling on a bus and the driver gets a sudden severe stomach ache and loses focus. He...",
    "He is accused of cheating in a chemistry test that he had prepared well for. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set59/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital pyrometer in a high-temperature furnace room."
  },

  "PI": [
    "How do you handle a situation where a temperature measurement instrument fails during a furnace project?",
    "Tell me about a time you led a team to paint or renovate a community health center or school.",
    "What is your understanding of the strategic importance of quantum dots in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the sale of adulterated spices or food?",
    "What are the technical challenges in testing the creep resistance of high-temperature alloys?",
    "How do you handle a situation where you are falsely accused of cheating in a chemistry test?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set59/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_59.json"), 'w', encoding='utf-8') as f:
    json.dump(set_59_data, f, indent=2)

print("Set 59 created successfully with CPSS.")
