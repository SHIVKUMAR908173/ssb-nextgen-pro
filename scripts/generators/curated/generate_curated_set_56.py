...
set_56_data = {
  "set_id": "SET_56",
  "description": "High-Quality Curated SSB Dataset - Set 56",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital anemometer on a meteorological tower.", "image_url": "https://picsum.photos/seed/tat_set56_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a thermoelectric generator module for waste heat recovery.", "image_url": "https://picsum.photos/seed/tat_set56_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing dry weeds from a roadside plantation to prevent fires.", "image_url": "https://picsum.photos/seed/tat_set56_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining Atal Pension Yojana benefits and registration to senior citizens.", "image_url": "https://picsum.photos/seed/tat_set56_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the burst pressure of a composite gas cylinder.", "image_url": "https://picsum.photos/seed/tat_set56_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting formation flight rendezvous points on a navigation chart.", "image_url": "https://picsum.photos/seed/tat_set56_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged tensioner on a factory conveyor belt.", "image_url": "https://picsum.photos/seed/tat_set56_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a disaster preparedness drill in a primary school.", "image_url": "https://picsum.photos/seed/tat_set56_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring red panda habitats using aerial drone surveys.", "image_url": "https://picsum.photos/seed/tat_set56_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a digital soil salinity tester to check field health.", "image_url": "https://picsum.photos/seed/tat_set56_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring parcel damage rates on a live operations dashboard.", "image_url": "https://picsum.photos/seed/tat_set56_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Anemometer", "Thermoelectric", "Plantation", "Pension", "Burst", "Rendezvous", "Tensioner", "Disaster", "Red-panda", "Salinity", 
  ...
  "SRT": [
    "He is calibrating a digital anemometer and the reading fluctuates wildly due to wind turbulence. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB rendezvous check. He...",
    "He discovers that a local gas cylinder is leaking LPG in the kitchen area. He...",
    "While conducting a disaster drill, he notices a short circuit in the alarm system causing sparks. He...",
    "He is organizing a district tug-of-war tournament and the main referee refuses to continue due to a dispute. He...",
    "He finds a lost pouch containing vehicle keys and an RC book lying on a park bench. He...",
    "He is preparing for his competitive entrance exam but the hostel internet connection fails. He...",
    "A swarm of wild bees attacks his group during a picnic in the park. He...",
    "He is traveling on a bus and the driver gets a severe leg cramp and loses control. He...",
    "He is accused of cheating in a coding test that he had solved using his own logic. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set56/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital anemometer on a meteorological tower."
  },

  "PI": [
    "How do you handle a situation where a wind measurement instrument fails during a meteorological project?",
    "Tell me about a time you led a team to clear weeds or prevent fires in a plantation or public space.",
    "What is your understanding of the strategic importance of thermoelectric materials in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against the leakage of gas or hazardous materials?",
    "What are the technical challenges in testing the burst pressure of composite cylinders?",
    "How do you handle a situation where you are falsely accused of cheating in a coding test?",
  ...
  "Lecturette": [
    "Thermoelectric Technology: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like thermoelectrics be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set56/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_56.json"), 'w', encoding='utf-8') as f:
    json.dump(set_56_data, f, indent=2)

print("Set 56 created successfully with CPSS.")
