...
set_28_data = {
  "set_id": "SET_28",
  "description": "High-Quality Curated SSB Dataset - Set 28",
  "TAT": [
    {"pic_no": 1, "description": "A young geologist mapping structural fault lines with a geological compass on a rocky ridge.", "image_url": "https://picsum.photos/seed/tat_set28_1/800/600"},
    {"pic_no": 2, "description": "A research technician checking alignment on a high-precision chemical spectrometer in a lab.", "image_url": "https://picsum.photos/seed/tat_set28_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets painting clean-water storage tanks in a remote village community center.", "image_url": "https://picsum.photos/seed/tat_set28_3/800/600"},
    {"pic_no": 4, "description": "A healthcare worker demonstrating infant CPR techniques using a dummy to first-time parents.", "image_url": "https://picsum.photos/seed/tat_set28_4/800/600"},
    {"pic_no": 5, "description": "A design engineer adjusting solar sun-tracker linkages on a mountaintop weather cabin roof.", "image_url": "https://picsum.photos/seed/tat_set28_5/800/600"},
    {"pic_no": 6, "description": "An instructor demonstrating basic field map coordinates to cadets around a large outdoor chalkboard.", "image_url": "https://picsum.photos/seed/tat_set28_6/800/600"},
    {"pic_no": 7, "description": "A pilot checking fuel line bleed valve seals on the delta wing of a fighter jet.", "image_url": "https://picsum.photos/seed/tat_set28_7/800/600"},
    {"pic_no": 8, "description": "A student volunteering to lead a digital bank account security camp for local market vendors.", "image_url": "https://picsum.photos/seed/tat_set28_8/800/600"},
    {"pic_no": 9, "description": "Two marine conservationists placing concrete nursery domes to secure baby oyster polyps in a bay.", "image_url": "https://picsum.photos/seed/tat_set28_9/800/600"},
    {"pic_no": 10, "description": "A woman carefully picking fresh red cherries in a high-density orchard using a mesh picking pole.", "image_url": "https://picsum.photos/seed/tat_set28_10/800/600"},
    {"pic_no": 11, "description": "A volunteer rescue team organizing dry survival rations and emergency blankets on a flooded lane.", "image_url": "https://picsum.photos/seed/tat_set28_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Fault", "Align", "Paint", "Dummy", "Tracker", "Plot", "Shield", "Oyster", "Pluck", "Sack", 
    "Valor", "Core", "Vigor", "Apex", "Keel", "Span", "Beam", "Bolt", "Weld", "Fuse", 
    "Joint", "Ring", "Spur", "Crest", "Ridge", "Sow", "Till", "Plow", "Dig", "Mine", 
    "Gold", "Steel", "Alloy", "Firm", "Stout", "Brave", "Wild", "Calm", "Cool", "Placid", 
    "Mild", "Warm", "Cheer", "Bright", "Glow", "Light", "Hope", "Trust", "True", "Sinc", 
    "Pure", "Clean", "Neat", "Trim", "Tidy", "Snug", "Safe", "Sure", "Rely", "Equal"
  ],

  "SRT": [
    "He is leading a structural survey team and a sudden landslide blocks the main escape path to their vehicle. He...",
    "His younger brother's university enrollment reporting falls on the exact morning of his crucial SSB pilot battery tests. He...",
    "He discovers his neighbors are storing high-pressure chemical spray cylinders illegally in their backyard. He...",
    "While riding a bicycle, he notices the high-voltage lines are touching a dry wooden fence, causing sparks. He...",
    "He is organizing a national software seminar and the main projection console catches fire right before the keynote. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set28/800/600?blur=5",
    "description": "Hazy picture of a young geologist mapping structural fault lines with a geological compass on a rocky ridge."
  },

  "PI": [
    "How do you handle a colleague who repeatedly speaks over you during high-priority group meetings?",
    "Tell me about a time you coordinated a massive solar panel installation drive for a local school.",
    "What is your view on the military utility of anti-satellite (ASAT) weapons in space warfare?",
    "How do you prepare your revision sheets for highly quantitative physical chemistry topics?",
    "Tell me about a time you took the lead to resolve a serious lease dispute between college flatmates.",
    "What are the main tactical differences between aircraft carriers with CATOBAR systems vs STOBAR systems?",
    "How do you handle peer pressure when your friends encourage you to bunk core research lab sessions?",
    "Tell me about a time you had to learn how to operate an advanced CNC mill or lathe within a week.",
    "If your group's budget is cut by 60% right before executing an outdoor campaign, how do you adjust?",
    "What is your opinion on the strategic utility of the Chabahar Port in India's regional connectivity?",
    "Tell me about a major family crisis where you took the lead to manage all medical and insurance paperwork.",
    "What is the difference between physical endurance and cognitive stamina, in your own words?",
    "What is the significance of the military motto 'Shatrujeet' in your own daily interactions?",
    "How do you manage a teammate who is highly detail-oriented but extremely slow to deliver results?",
    "What role does strategic deception play in modern counter-insurgency warfare?",
    "Tell me about a time you volunteered to manage the safety logistics for a large college sports meet.",
    "What are your views on the geopolitical challenges of the India-Myanmar-Thailand Trilateral Highway?",
    "If you are selected, how do you plan to contribute to the indigenization of naval electrical architectures?",
    "How do you deal with a sibling who has developed a deep addiction to screen time and gaming?",
    "What is the most physically demanding mountain trek or high-altitude cycle trip you have ever done?"
  ],
  ...
  "Lecturette": [
    "The Strategic Utility of Anti-Satellite (ASAT) Weapons",
    "Chabahar Port: Geopolitics of India's Regional Connectivity",
    "India-Myanmar-Thailand Trilateral Highway: Opportunities & Challenges",
    "The Distinction Between Physical Endurance and Cognitive Stamina"
  ],

  "GD": [
    "Should the weaponization of low-Earth orbit be banned under strict UN penalties, or is space-based defense essential for national sovereignty?",
    "Does the growth of vertical farming solve urban food security challenges, or is it an expensive distraction from rural agriculture?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set28/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_28.json"), 'w', encoding='utf-8') as f:
    json.dump(set_28_data, f, indent=2)

print("Set 28 created successfully with CPSS.")
