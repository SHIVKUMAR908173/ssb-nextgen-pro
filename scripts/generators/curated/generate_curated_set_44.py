...
set_44_data = {
  "set_id": "SET_44",
  "description": "High-Quality Curated SSB Dataset - Set 44",
  "TAT": [
    {"pic_no": 1, "description": "A young technician adjusting a digital optical densitometer scanner inside a biological cleanroom.", "image_url": "https://picsum.photos/seed/tat_set44_1/800/600"},
    {"pic_no": 2, "description": "A research engineer checking temperature readouts on a liquid methane coolant storage line.", "image_url": "https://picsum.photos/seed/tat_set44_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing broken slate tiles from a historical mountain shrine pathway.", "image_url": "https://picsum.photos/seed/tat_set44_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining zero-interest rural animal husbandry insurance schemes to small farmers.", "image_url": "https://picsum.photos/seed/tat_set44_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector checking anchor cables on a newly constructed steel suspension footbridge.", "image_url": "https://picsum.photos/seed/tat_set44_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet drawing flight route coordinates on a weather prediction satellite display.", "image_url": "https://picsum.photos/seed/tat_set44_6/800/600"},
    {"pic_no": 7, "description": "A mechanic fitting replacement rotary cutting blades onto a large industrial trench cutter.", "image_url": "https://picsum.photos/seed/tat_set44_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing fresh sterile gauze pads and antiseptic swabs at a village camp.", "image_url": "https://picsum.photos/seed/tat_set44_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists building rock-filled wooden cribs to prevent river channel bank erosion.", "image_url": "https://picsum.photos/seed/tat_set44_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking ripe apples in a hillside orchard using a cushioned shoulder bag.", "image_url": "https://picsum.photos/seed/tat_set44_10/800/600"},
    {"pic_no": 11, "description": "A rail dispatcher monitoring locomotive dispatch corridors on a large terminal control board.", "image_url": "https://picsum.photos/seed/tat_set44_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Densitometer", "Coolant", "Pathway", "Husbandry", "Suspension", "Coordinates", "Rotary", "Antiseptic", "Erosion", "Orchard", 
  ...
  "SRT": [
    "He is leading a cleanroom densitometer calibration team and a sudden sudden voltage surge burns the laser scanner. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB weather satellite plotting check. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set44/800/600?blur=5",
    "description": "Hazy picture of a young technician adjusting a digital optical densitometer scanner inside a biological cleanroom."
  },

  "PI": [
    "How do you handle a laboratory supervisor who frequently points out minor measurement inconsistencies during live evaluations?",
    "Tell me about a time you organized a volunteer group to clear dry slate rubble from a local hiking route.",
    "What is your view on the military advantages of sub-meter resolution weather prediction satellites?",
    "How do you manage your physical preparation schedule when you are traveling frequently for academic symposiums?",
    "Tell me about a time you stood up against biased hostel utility charge distributions in college.",
    "What are the main engineering challenges in designing high-temperature molten salt solar thermal systems?",
    "How do you resolve a transport conflict when two student teams require the exact same logistics vehicle?",
    "Tell me about a time you successfully helped a classmate overcome a severe panic episode right before a major job interview.",
    "If you are assigned to a project team where the former coordinator works directly under you, how do you gain their respect?",
    "What is your opinion on the strategic role of Red Sea shipping lane safety treaties?",
    "Tell me about a major family logistics task you completed during an unexpected local natural gas leak.",
    "What does team discipline mean to you when executing a complex progressive cantilever obstacle crossing?",
    "What is the significance of the motto 'Service and Sincerity' in your personal choice of career?",
    "How do you handle a classmate who has extreme creative conceptualization capabilities but completely lacks structural realism?",
    "What role does emergency satellite telemetry play in predicting volcanic ash cloud dispersal routes?",
    "Tell me about a time you volunteered to manage audience queue lines during a crowded regional sports championship.",
    "What are your views on India's strategic maritime partnership with South Indian Ocean littoral nations?",
    "If you are not selected, what master's programs in autonomous flight controls or rocket engine telemetry will you pursue?",
    "How do you handle a classmate who constantly utilizes your library research outcomes without acknowledgment?",
    "What is the most challenging 100-kilometer bicycle expedition or high-altitude mountaineering trek you have completed?"
  ],
  ...
  "Lecturette": [
    "Molten Salt Solar: Core High-Temperature Engineering Challenges",
    "Sub-meter Satellites: Strategic Advantages in Weather Prediction",
    "Red Sea Shipping: Treaties, Logistics, and Maritime Safety",
    "Satellite Telemetry in Volcanic Ash Dispersal Forecasting"
  ],

  "GD": [
    "Should the development of molten salt solar collectors and high-capacity storage platforms be funded exclusively by local public entities, or should private energy conglomerates be granted unlimited patent titles to accelerate development?",
    "Does the rapid integration of central bank digital currencies (CBDC) reduce transaction fraud, or does it merely lead to systemic privacy violations and state surveillance of citizen habits?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set44/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_44.json"), 'w', encoding='utf-8') as f:
    json.dump(set_44_data, f, indent=2)

print("Set 44 created successfully with CPSS.")
