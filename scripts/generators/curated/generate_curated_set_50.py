...
set_50_data = {
  "set_id": "SET_50",
  "description": "High-Quality Curated SSB Dataset - Set 50",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a digital multimeter on a solar inverter panel.", "image_url": "https://picsum.photos/seed/tat_set50_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a bio-degradable polymer film for packaging applications.", "image_url": "https://picsum.photos/seed/tat_set50_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing wild weeds from a neglected heritage wall in a fort.", "image_url": "https://picsum.photos/seed/tat_set50_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining PM-KISAN scheme benefits to small and marginal farmers.", "image_url": "https://picsum.photos/seed/tat_set50_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the load capacity of a newly built steel gantry crane.", "image_url": "https://picsum.photos/seed/tat_set50_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting night navigation routes on a glowing cockpit display.", "image_url": "https://picsum.photos/seed/tat_set50_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged gear in a heavy-duty winch assembly.", "image_url": "https://picsum.photos/seed/tat_set50_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing masks and sanitizers in a crowded local market.", "image_url": "https://picsum.photos/seed/tat_set50_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring tiger tracks using plaster casts in a wildlife reserve.", "image_url": "https://picsum.photos/seed/tat_set50_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a handheld grain moisture tester to check harvested wheat.", "image_url": "https://picsum.photos/seed/tat_set50_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager tracking a fleet of oxygen tankers on a central control screen.", "image_url": "https://picsum.photos/seed/tat_set50_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Multimeter", "Polymer", "Heritage", "Scheme", "Gantry", "Navigation", "Winch", "Sanitizer", "Tracks", "Moisture", 
  ...
  "SRT": [
    "He is calibrating a digital multimeter and it reads zero due to a blown internal fuse. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB night navigation check. He...",
    "He discovers that a local hospital is dumping biomedical waste in an open ground near a school. He...",
    "While walking in a shopping mall, he notices a short circuit in a decorative light fitting causing sparks. He...",
    "He is organizing a college quiz competition and the main buzzer system fails during the final round. He...",
    "He finds a lost mobile phone with active UPI apps open lying on an airport bus seat. He...",
    "He is preparing for his competitive entrance exam but the hostel lift gets stuck with him inside. He...",
    "A herd of stray cattle enters and damages the standing crops on his farm. He...",
    "He is traveling on a highway bus and the driver feels dizzy and stops the bus on the shoulder. He...",
    "He is accused of plagiarizing a seminar paper that he had prepared after months of research. He...",
    "He is coordinating a state kabaddi league and the referee refuses to continue due to aggressive protests by a team coach. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set50/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a digital multimeter on a solar inverter panel."
  },

  "PI": [
    "How do you handle a situation where a measurement tool fails during a practical exam or project?",
    "Tell me about a time you led a team to clean up or restore a neglected historical or public space.",
    "What is your understanding of the strategic importance of bio-degradable polymers in defense?",
    "How do you balance your training for SSB with your professional or academic commitments?",
    "Have you ever reported or taken action against illegal dumping of waste or pollution?",
    "What are the technical challenges in designing high-capacity gantry cranes?",
  ...
  "Lecturette": [
    "Bio-degradable Polymers: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like bio-degradable polymers be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set50/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_50.json"), 'w', encoding='utf-8') as f:
    json.dump(set_50_data, f, indent=2)

print("Set 50 created successfully with CPSS.")
