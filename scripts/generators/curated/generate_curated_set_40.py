...
set_40_data = {
  "set_id": "SET_40",
  "description": "High-Quality Curated SSB Dataset - Set 40",
  "TAT": [
    {"pic_no": 1, "description": "A young technician repairing a solar-powered wind indicator at a coastal weather tower.", "image_url": "https://picsum.photos/seed/tat_set40_1/800/600"},
    {"pic_no": 2, "description": "A research scientist checking laser cooling tubes under a high-vacuum chamber frame.", "image_url": "https://picsum.photos/seed/tat_set40_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing thick thorny weeds to open a forest trekking path.", "image_url": "https://picsum.photos/seed/tat_set40_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining low-interest educational loan details to rural high schoolers.", "image_url": "https://picsum.photos/seed/tat_set40_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector checking tension guy-wires on a newly built highway transmission mast.", "image_url": "https://picsum.photos/seed/tat_set40_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet matching grid sections on a regional topographical navigation map.", "image_url": "https://picsum.photos/seed/tat_set40_6/800/600"},
    {"pic_no": 7, "description": "A mechanic replacing planetary reduction gears on a heavy-duty loader transmission.", "image_url": "https://picsum.photos/seed/tat_set40_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer distributing primary sterile bandages and burn ointments at a relief base.", "image_url": "https://picsum.photos/seed/tat_set40_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists positioning cement nesting domes to save marine blue-ringed octopuses.", "image_url": "https://picsum.photos/seed/tat_set40_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking ripe peaches in a hillside orchard using a double-pocket canvas harness.", "image_url": "https://picsum.photos/seed/tat_set40_10/800/600"},
    {"pic_no": 11, "description": "A logistics coordinator tracking heavy cargo transits on a multi-screen port console.", "image_url": "https://picsum.photos/seed/tat_set40_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Wind", "Cooling", "Weeds", "Low-interest", "Guy-wires", "Topographical", "Reduction", "Ointments", "Octopuses", "Peaches", 
  ...
  "SRT": [
    "He is leading a solar wind indicator installation team and a sudden strong gale damages the orientation shaft. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB compass navigation check. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set40/800/600?blur=5",
    "description": "Hazy picture of a young technician repairing a solar-powered wind indicator at a coastal weather tower."
  },

  "PI": [
    "How do you handle a project lead who constantly revises engineering specifications right before a critical assembly?",
    "Tell me about a time you organized a volunteer crew to clear local storm drains before heavy rain seasons.",
    "What is your view on the strategic challenge of high-altitude long-endurance (HALE) drone surveillance platforms?",
    "How do you manage your physical training performance under dense sub-zero winter camp conditions?",
    "Tell me about a time you stood up against unfair laboratory resource sharing practices in your department.",
    "What are the key differences between laser-based and radio-frequency based satellite communication systems?",
    "How do you resolve a computing memory bottleneck when running complex aerodynamics models?",
    "Tell me about a time you successfully helped a co-cadet recover their composure after a major panic episode.",
    "If you are assigned to a team where the former coordinator works directly under you, how do you handle it?",
    "What is your opinion on the strategic significance of the Northeast Passage marine trade routes?",
    "Tell me about a major logistics task you completed during a sudden local power grid failure.",
    "What does team discipline mean to you when executing a complex cantilever obstacle crossing?",
    "What is the significance of the motto 'Service and Selflessness' in your daily choices?",
    "How do you handle a classmate who has extreme creative intelligence but completely lacks structural accuracy?",
    "What role does emergency satellite telemetry play in forecasting deep-sea tectonic plate movements?",
    "Tell me about a time you volunteered to coordinate safety barricades during a crowded public exhibition.",
    "What are your views on India's strategic partnership with Baltic Sea littoral nations?",
    "If you are not selected, what master's programs in autonomous helicopter dynamics or flight controls will you pursue?",
    "How do you handle a roommate who constantly shares your personal computer password without your consent?",
    "What is the most challenging 200-kilometer cycle expedition or survival trekking camp you have completed?"
  ],
  ...
  "Lecturette": [
    "HALE Drones: High-Altitude Long-Endurance Surveillance Frontiers",
    "Laser vs Radio-Frequency Satellite Communications: Main Advantages",
    "The Northeast Passage: Strategic and Commercial Trade Value",
    "Satellite Telemetry in Deep-Sea Tectonic Monitoring"
  ],

  "GD": [
    "Should space exploration and deep-space mining systems be funded exclusively through international public treaties, or should private entities be granted unlimited patent titles to accelerate development?",
    "Does the rapid integration of artificial intelligence in law enforcement forecasting reduce crime rates, or does it merely lead to systemic demographic profiling and biased policing?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set40/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_40.json"), 'w', encoding='utf-8') as f:
    json.dump(set_40_data, f, indent=2)

print("Set 40 created successfully with CPSS.")
