...
set_49_data = {
  "set_id": "SET_49",
  "description": "High-Quality Curated SSB Dataset - Set 49",
  "TAT": [
    {"pic_no": 1, "description": "A young technician calibrating a turbidimeter in a municipal water treatment plant.", "image_url": "https://picsum.photos/seed/tat_set49_1/800/600"},
    {"pic_no": 2, "description": "A research engineer inspecting a shape-memory alloy wire for aerospace actuator applications.", "image_url": "https://picsum.photos/seed/tat_set49_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing plastic waste and debris from a river bank.", "image_url": "https://picsum.photos/seed/tat_set49_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer explaining weather-based crop insurance schemes to small farmers.", "image_url": "https://picsum.photos/seed/tat_set49_4/800/600"},
    {"pic_no": 5, "description": "A structural inspector testing the load capacity of a newly fabricated carbon fiber beam.", "image_url": "https://picsum.photos/seed/tat_set49_5/800/600"},
    {"pic_no": 6, "description": "A flight cadet plotting thunderstorm avoidance routes on a weather radar display.", "image_url": "https://picsum.photos/seed/tat_set49_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing a damaged impeller on a large submersible pump.", "image_url": "https://picsum.photos/seed/tat_set49_7/800/600"},
    {"pic_no": 8, "description": "A student volunteer organizing a tree plantation drive on a barren community land.", "image_url": "https://picsum.photos/seed/tat_set49_8/800/600"},
    {"pic_no": 9, "description": "Two conservationists monitoring wild elephant movement using radio collars in a reserve.", "image_url": "https://picsum.photos/seed/tat_set49_9/800/600"},
    {"pic_no": 10, "description": "A farmer using a soil salinity sensor probe to check the health of a field.", "image_url": "https://picsum.photos/seed/tat_set49_10/800/600"},
    {"pic_no": 11, "description": "A logistics manager monitoring freight train movements on a division control map.", "image_url": "https://picsum.photos/seed/tat_set49_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Turbidimeter", "Shape-memory", "Debris", "Insurance", "Carbon-fiber", "Thunderstorm", "Submersible", "Plantation", "Radio-collar", "Salinity", 
  ...
  "SRT": [
    "He is calibrating a turbidimeter and the reading fluctuates wildly due to a faulty light source. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB thunderstorm avoidance check. He...",
    "He discovers that a local chemical plant is leaking chlorine gas into the atmosphere. He...",
    "While walking in the rain, he notices a short circuit in a street light pole causing sparks near a tree. He...",
    "He is organizing a college basketball match and the main electronic scoreboard fails during the final quarter. He...",
    "He finds a lost bag containing a passport and flight tickets lying on an airport bus seat. He...",
    "He is preparing for his competitive entrance exam but the hostel mess workers go on strike. He...",
    "A pack of wild dogs attacks a poultry farm in his village. He...",
    "He is traveling on a highway bus and the driver faints due to a sudden medical emergency. He...",
    "He is accused of cheating in an online test that he had taken honestly. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set49/800/600?blur=5",
    "description": "Hazy picture of a young technician calibrating a turbidimeter in a municipal water treatment plant."
  },

  "PI": [
    "How do you handle a situation where a critical measurement instrument fails during a lab experiment?",
    "Tell me about a time you led a team to clear plastic waste or clean up a polluted area.",
    "What is your understanding of the strategic importance of shape-memory alloys in defense?",
    "How do you manage your time between academic preparation and physical training for SSB?",
    "Have you ever reported or taken action against illegal industrial pollution in your area?",
    "What are the technical challenges in designing high-strength carbon fiber structures?",
    "How do you handle a situation where you are falsely accused of cheating or misconduct?",
  ...
  "Lecturette": [
    "Shape-Memory Alloys: Principles and Defense Applications",
  ...
  "GD": [
    "Should the development of advanced materials like shape-memory alloys be funded exclusively by the defense budget, or should commercial industries be incentivized to lead the research?",
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set49/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_49.json"), 'w', encoding='utf-8') as f:
    json.dump(set_49_data, f, indent=2)

print("Set 49 created successfully with CPSS.")
