...
set_35_data = {
  "set_id": "SET_35",
  "description": "High-Quality Curated SSB Dataset - Set 35",
  "TAT": [
    {"pic_no": 1, "description": "A young technician repairing a solar-powered automatic weather station on a grassy hill.", "image_url": "https://picsum.photos/seed/tat_set35_1/800/600"},
    {"pic_no": 2, "description": "A research scientist checking calibration alignment on a high-precision laser interferometer.", "image_url": "https://picsum.photos/seed/tat_set35_2/800/600"},
    {"pic_no": 3, "description": "A group of NCC cadets clearing plastic debris from a dry riverbed before monsoon rains.", "image_url": "https://picsum.photos/seed/tat_set35_3/800/600"},
    {"pic_no": 4, "description": "A student volunteer teaching basic online payment safety protocols to local street food vendors.", "image_url": "https://picsum.photos/seed/tat_set35_4/800/600"},
    {"pic_no": 5, "description": "A structural engineer inspecting cable stays on a high-span highway transmission mast.", "image_url": "https://picsum.photos/seed/tat_set35_5/800/600"},
    {"pic_no": 6, "description": "An instructor demonstrating search pattern navigation vectors to cadets on a digital display.", "image_url": "https://picsum.photos/seed/tat_set35_6/800/600"},
    {"pic_no": 7, "description": "A mechanic repairing the planetary gearbox of a tracked excavator in a servicing yard.", "image_url": "https://picsum.photos/seed/tat_set35_7/800/600"},
    {"pic_no": 8, "description": "A student delivering primary hygiene kits and water purification tablets to a relief camp.", "image_url": "https://picsum.photos/seed/tat_set35_8/800/600"},
    {"pic_no": 9, "description": "Two researchers placing concrete mesh panels to restore seaweed growth in a marine lagoon.", "image_url": "https://picsum.photos/seed/tat_set35_9/800/600"},
    {"pic_no": 10, "description": "A farmer picking fresh pomegranates in an organic orchard using a padded harvesting pole.", "image_url": "https://picsum.photos/seed/tat_set35_10/800/600"},
    {"pic_no": 11, "description": "A dispatcher monitoring rescue ambulance transit routes on a dual-screen control board.", "image_url": "https://picsum.photos/seed/tat_set35_11/800/600"},
    {"pic_no": 12, "description": "BLANK PICTURE", "image_url": None}
  ],
  
  "WAT": [
    "Interferometer", "Riverbed", "Protocols", "High-span", "Vectors", "Excavator", "Lagoon", "Padded", "Dispatcher", "Grassy", 
    "Apex", "Bold", "Cope", "Drive", "Earn", "Firm", "Glow", "Hope", "Keen", "Light", 
    "Mild", "Neat", "Pure", "Rely", "Safe", "Trust", "Valor", "Warm", "Yield", "Sovereign", 
    "Hasten", "Grip", "Talon", "Glide", "Orbit", "Drill", "Vault", "Quell", "Rally", "Blaze", 
    "Forge", "Anchor", "Vessel", "Summit", "Plunge", "Vigour", "Robust", "Steady", "Ample", "Sturdy", 
    "Zenith", "Nadir", "Crest", "Flank", "Brave", "Calm", "Cheer", "Bright", "True"
  ],

  "SRT": [
    "He is leading an automatic weather station setup team and a sudden lightning strike damages the main receiver. He...",
    "His sister's final board exam reporting time falls on the exact morning of his crucial SSB medical clearance check. He...",
  ...
  "PPDT": {
    "image_url": "https://picsum.photos/seed/ppdt_set35/800/600?blur=5",
    "description": "Hazy picture of a young technician repairing a solar-powered automatic weather station on a grassy hill."
  },

  "PI": [
    "How do you handle a teammate who continuously challenges your feedback in an aggressive manner?",
    "Tell me about a time you organized a campus-wide e-waste collection and recycling campaign.",
    "What is your view on the strategic importance of the International North-South Transport Corridor (INSTC)?",
    "How do you maintain structural discipline in your physical fitness during long monsoon seasons?",
    "Tell me about a time you had to challenge a highly biased decision made by a college club jury.",
    "What are the primary technical hurdles in building and launching reusable launch vehicles (RLVs)?",
    "How do you prioritize your resource allocations when you are managing two parallel college festivals?",
    "Tell me about a time you successfully helped a local shopkeeper set up a secure digital payment portal.",
    "If you are assigned to lead a team where the former leader has stayed on as a regular member, how do you handle it?",
    "What is your opinion on the geopolitical impact of international satellite spectrum allocations?",
    "Tell me about a major logistics challenge you solved during a family wedding or community gathering.",
    "What is the difference between healthy confidence and quiet arrogance in a leader, in your own words?",
    "What is the significance of the motto 'Valour and Wisdom' in your everyday academic pursuits?",
    "How do you deal with a team member who has high emotional intelligence but low technical output?",
    "What role does tactical speed play in preventing emergency situations from escalating?",
    "Tell me about a time you volunteered to manage safety queues during a local crowded vaccination drive.",
    "What are your views on India's strategic partnerships with Arctic Council observer states?",
    "If you are not selected, what backup careers in drone manufacturing or aerospace supply chains have you considered?",
    "How do you handle a classmate who consistently borrows your lab components and returns them broken?",
    "What is the most demanding cycle expedition or outdoor cross-country race you have completed?"
  ],
  ...
  "Lecturette": [
    "International North-South Transport Corridor (INSTC): Geopolitical Value",
    "Reusable Launch Vehicles (RLVs): Technology and Challenges",
    "Arctic Council and India's Strategic Arctic Policy",
    "The Role of Tactical Speed in Disaster and Crisis Mitigation"
  ],

  "GD": [
    "Should outer space be designated as a completely non-militarized zone under a binding UN treaty, or is weaponization an inevitable consequence of power politics?",
    "Does the rapid digitization of government records in developing countries compromise citizen privacy, or is it the only way to eliminate systemic corruption?"
  ],
  ...
  "GPE": {
    ...
    "map_url": "https://picsum.photos/seed/gpe_map_set35/800/600"
  },
...
with open(os.path.join(OUTPUT_DIR, "set_35.json"), 'w', encoding='utf-8') as f:
    json.dump(set_35_data, f, indent=2)

print("Set 35 created successfully with CPSS.")
