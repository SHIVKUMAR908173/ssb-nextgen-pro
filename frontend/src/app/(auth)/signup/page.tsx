    ...
    <div className="flex min-h-screen w-full">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#020617]">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="relative"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-[#1E3A5F]" /></div><div className="relative flex justify-center text-[10px]"><span className="bg-[#020617] px-4 text-slate-600 font-black uppercase tracking-widest">Or</span></div></div>
