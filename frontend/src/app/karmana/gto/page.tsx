...
const GTO_TASKS = [
  ...
  { id: 'pgt', name: 'Progressive Group Task', shortName: 'PGT', category: 'Outdoor', duration: '45 min', href: '/karmana/pgt', color: 'emerald', emoji: '🏗️', difficulty: 'Hard', xp: 250 },
  { id: 'hgt', name: 'Half Group Task', shortName: 'HGT', category: 'Outdoor', duration: '25 min', href: '/karmana/hgt', color: 'blue', emoji: '👥', difficulty: 'Hard', xp: 200 },
  { id: 'ct', name: 'Command Task', shortName: 'CT', category: 'Leadership', duration: '15 min', href: '/karmana/ct', color: 'purple', emoji: '👑', difficulty: 'Expert', xp: 300 },
  { id: 'fgt', name: 'Final Group Task', shortName: 'FGT', category: 'Outdoor', duration: '30 min', href: '/karmana/fgt', color: 'amber', emoji: '🏁', difficulty: 'Hard', xp: 200 },
  { id: 'snake', name: 'Snake Race', shortName: 'SR', category: 'Team Race', duration: '10 min', href: '/karmana/snake-race', color: 'emerald', emoji: '🐍', difficulty: 'Medium', xp: 150 },
  ...
  { id: 'outdoor', name: 'Outdoor Group Tasks', shortName: 'OGT', category: 'Outdoor', duration: '30 min', href: '/karmana/outdoor', color: 'emerald', emoji: '🌲', difficulty: 'Medium', xp: 150 },
  { id: 'helping', name: 'Helping Material Tasks', shortName: 'HMT', category: 'Materials', duration: '20 min', href: '/karmana/outdoor', color: 'orange', emoji: '🔧', difficulty: 'Medium', xp: 150 },
