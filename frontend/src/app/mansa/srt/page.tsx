...
import { Zap, ArrowLeft, Radio, Clock, Sparkles } from 'lucide-react'
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
           <div className="space-y-6">
              <div className="bg-yellow-500/10 border border-yellow-500/20 px-4 py-1.5 rounded-full flex items-center gap-2 max-w-fit mx-auto md:mx-0">
                 ...
                 <span className="text-[10px] font-black text-yellow-500 uppercase tracking-[0.2em]">Situation Reaction Test</span>
              </div>
              <h1 className="text-4xl md:text-8xl font-black text-white uppercase tracking-tighter leading-none">
                 SRT <span className="text-yellow-500">Sim</span>
              </h1>
              <p className="text-slate-400 max-w-xl text-lg font-bold">
                 React to 60 real-life dilemmas. 30 minutes total to provide logical, officer-grade solutions to each crisis.
              </p>
           </div>
           
           <div className="bg-[#162840] border border-white/5 rounded-[40px] p-10 min-w-[240px] shadow-2xl">
              <Clock className="w-12 h-12 text-yellow-500 mx-auto mb-4" />
              <p className="text-2xl font-black text-white uppercase tracking-tight">30 <span className="text-xs text-slate-500">Minutes Total</span></p>
           </div>
        </div>
      </motion.div>
