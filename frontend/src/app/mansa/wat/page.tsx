...
import { MessageSquare, ArrowLeft, Radio, Clock, Sparkles } from 'lucide-react'
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
           <div className="space-y-6">
              <div className="bg-blue-500/10 border border-blue-500/20 px-4 py-1.5 rounded-full flex items-center gap-2 max-w-fit mx-auto md:mx-0">
                 <MessageSquare className="w-3 h-3 text-blue-500" />
                 <span className="text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">Word Association Test</span>
              </div>
              <h1 className="text-4xl md:text-8xl font-black text-white uppercase tracking-tighter leading-none">
                 WAT <span className="text-blue-600">Sim</span>
              </h1>
              <p className="text-slate-400 max-w-xl text-lg font-bold">
                 Respond to 60 words appearing for 15 seconds each. Instant subconscious response required.
              </p>
           </div>
           
           <div className="bg-[#162840] border border-white/5 rounded-[40px] p-10 min-w-[240px] shadow-2xl">
              <Clock className="w-12 h-12 text-blue-500 mx-auto mb-4" />
              <p className="text-2xl font-black text-white uppercase tracking-tight">15 <span className="text-xs text-slate-500">Seconds / Word</span></p>
           </div>
        </div>
      </motion.div>
